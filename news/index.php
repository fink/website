...
<a name="2002-12-22 New Upgrade Matrix" /><span class="news_date">2002-12-22: </span><span class="news_headline">New Upgrade Matrix</span><?php gray_line(); ?>
  ...
  <a name="2002-12-11 New Upgrade Matrix coming" /><span class="news_date">2002-12-11: </span><span class="news_headline">New Upgrade Matrix coming</span><?php gray_line(); ?>
...
made available on 2002-09-08.
  ...
  <a name="2002-12-09 Fink 0.5.0a Released" /><span class="news_date">2002-12-09: </span><span class="news_headline">Fink 0.5.0a Released</span><?php gray_line(); ?>
  <p>
  ...
  <a name="2002-11-11 Update XFree86 for use with OS X 10.2.2" /><span class="news_date">2002-11-11: </span><span class="news_headline">Update XFree86 for use with OS X 10.2.2</span><?php gray_line(); ?>
  <p>
...
&quot;fink selfupdate-cvs&quot; and/or enable the unstable tree
  ...
  <a name="2002-10-30 Don't reuse binary installer" /><span class="news_date">2002-10-30: </span><span class="news_headline">Don't reuse binary installer</span><?php gray_line(); ?>
  <p>
...
12582912 bytes, while the old version had a filesize of 10541112 bytes.)
</p><a name="2002-09-28 Fink 0.4.1 released" /><span class="news_date">2002-09-28: </span><span class="news_headline">Fink 0.4.1 released</span><?php gray_line(); ?>
    <p>
      The source release and the binary installer are available now, as well as all binary packages. For information about upgrading, visit the <a href="<?php print $root; ?>download/upgrade.php">Upgrade Matrix</a>. 
    </p>
    <p>
  ...
  <a name="2002-09-27 Possible conflicts with anti-virus software" /><span class="news_date">2002-09-27: </span><span class="news_headline">Possible conflicts with anti-virus software</span><?php gray_line(); ?>
...
software before using Fink.
</p><a name="2002-09-08 Test version of Jaguar updater available" /><span class="news_date">2002-09-08: </span><span class="news_headline">Test version of Jaguar updater available</span><?php gray_line(); ?>
		<p>
	...
	<a name="2002-08-20 Mac OS X 10.2 / Jaguar" /><span class="news_date">2002-08-20: </span><span class="news_headline">Mac OS X 10.2 / Jaguar</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-08-06 Fink package manager 0.10.0 released" /><span class="news_date">2002-08-06: </span><span class="news_headline">Fink package manager 0.10.0 released</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-07-17 Binary distribution moves" /><span class="news_date">2002-07-17: </span><span class="news_headline">Binary distribution moves</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-05-29 KDE support" /><span class="news_date">2002-05-29: </span><span class="news_headline">KDE support</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-05-03 Bug in passwd package" /><span class="news_date">2002-05-03: </span><span class="news_headline">Bug in passwd package</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-04-18 Fink 0.4.0 released" /><span class="news_date">2002-04-18: </span><span class="news_headline">Fink 0.4.0 released</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-01-16 Fink 0.3.2a is released" /><span class="news_date">2002-01-16: </span><span class="news_headline">Fink 0.3.2a is released</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-01-09 Fink 0.3.2 is released" /><span class="news_date">2002-01-09: </span><span class="news_headline">Fink 0.3.2 is released</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2002-01-08 Binary distribution lost" /><span class="news_date">2002-01-08: </span><span class="news_headline">Binary distribution lost</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-12-16 Yes, we are alive!" /><span class="news_date">2001-12-16: </span><span class="news_headline">Yes, we are alive!</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-11-04 Fink 0.3.1 is released" /><span class="news_date">2001-11-04: </span><span class="news_headline">Fink 0.3.1 is released</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-11-02 Running X11 document updated" /><span class="news_date">2001-11-02: </span><span class="news_headline">Running X11 document updated</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-10-31" /><span class="news_date">2001-10-31</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-10-23 forked.net" /><span class="news_date">2001-10-23: </span><span class="news_headline">forked.net</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-10-03 Binary distribution complete" /><span class="news_date">2001-10-03: </span><span class="news_headline">Binary distribution complete</span><?php gray_line(); ?>
  ...
  <a name="2001-09-30 Fink 0.3.0 is released" /><span class="news_date">2001-09-30: </span><span class="news_headline">Fink 0.3.0 is released</span><?php gray_line(); ?>
  ...
  <a name="2001-09-26 Mac OS X 10.1 released" /><span class="news_date">2001-09-26: </span><span class="news_headline">Mac OS X 10.1 released</span><?php gray_line(); ?>
  ...
  <a name="2001-09-07 Binary distribution fully updated" /><span class="news_date">2001-09-07: </span><span class="news_headline">Binary distribution fully updated</span><?php gray_line(); ?>
    <p>The binary distribution is now fully updated to
    Fink 0.2.6. Enjoy.
    </p>
  <a name="2001-09-04 Fink 0.2.6 is released" /><span class="news_date">2001-09-04: </span><span class="news_headline">Fink 0.2.6 is released</span><?php gray_line(); ?>
 ...
 <a name="2001-09-02 Fink IRC Channel" /><span class="news_date">2001-09-02: </span><span class="news_headline">Fink IRC Channel</span><?php gray_line(); ?>
 ...
 <a name="2001-08-25 Fink 0.2.5 was released" /><span class="news_date">2001-08-25: </span><span class="news_headline">Fink 0.2.5 was released</span><?php gray_line(); ?>
  ...
  <a name="2001-08-23 OpenOSX.com" /><span class="news_date">2001-08-23: </span><span class="news_headline">OpenOSX.com</span><?php gray_line(); ?>
 ...
 <a name="2001-08-22 New help page" /><span class="news_date">2001-08-22: </span><span class="news_headline">New help page</span><?php gray_line(); ?>
  ...
  <a name="2001-08-13 Porting tips and X11 document updated" /><span class="news_date">2001-08-13: </span><span class="news_headline">Porting tips and X11 document updated</span><?php gray_line(); ?>
  ...
  <a name="2001-08-01 Version 0.2.4a is released" /><span class="news_date">2001-08-01: </span><span class="news_headline">Version 0.2.4a is released</span><?php gray_line(); ?>
  ...
  <a name="2001-08-01 Version 0.2.4 is released" /><span class="news_date">2001-08-01: </span><span class="news_headline">Version 0.2.4 is released</span><?php gray_line(); ?>
  ...
  <a name="2001-07-19 New document: X11 on Darwin and Mac OS X" /><span class="news_date">2001-07-19: </span><span class="news_headline">New document: X11 on Darwin and Mac OS X</span><?php gray_line(); ?>
  ...
  <a name="2001-07-13 Package database now online" /><span class="news_date">2001-07-13: </span><span class="news_headline">Package database now online</span><?php gray_line(); ?>
    <p>A prototype of the <a href="<?php print $root; ?>pdb/index.php">package database</a>
    is now online.
    </p>
  <a name="2001-07-09 Version 0.2.3 is released" /><span class="news_date">2001-07-09: </span><span class="news_headline">Version 0.2.3 is released</span><?php gray_line(); ?>
  ...
  <a name="2001-07-03 Packaging Manual updated" /><span class="news_date">2001-07-03: </span><span class="news_headline">Packaging Manual updated</span><?php gray_line(); ?>
    <p>The <a href="<?php print $root; ?>doc/packaging/index.php">Packaging Manual</a> was
    updated to include all recently added fields.
    </p>
  <a name="2001-06-30 Web site restructuring" /><span class="news_date">2001-06-30: </span><span class="news_headline">Web site restructuring</span><?php gray_line(); ?>
  ...
  <a name="2001-06-24 Version 0.2.2 is released" /><span class="news_date">2001-06-24: </span><span class="news_headline">Version 0.2.2 is released</span><?php gray_line(); ?>
  ...
  <a name="2001-05-19 CVS instructions updated" /><span class="news_date">2001-05-19: </span><span class="news_headline">CVS instructions updated</span><?php gray_line(); ?>
    <p>The <a href="<?php print $root; ?>fink/cvs.php">CVS instructions</a> have
    been updated for Fink 0.2.x.
    </p>
  <a name="2001-04-26 FAQ online" /><span class="news_date">2001-04-26: </span><span class="news_headline">FAQ online</span><?php gray_line(); ?>
    <p>
      This site now sports a <a href="<?php print $root; ?>faq/index.php">FAQ section</a>. Not much content yet, but it's here to stay. 
    </p>
  <a name="2001-04-20 Version 0.2.0 is released" /><span class="news_date">2001-04-20: </span><span class="news_headline">Version 0.2.0 is released</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-04-15 Released version 0.1.8a" /><span class="news_date">2001-04-15: </span><span class="news_headline">Released version 0.1.8a</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-04-14 Version 0.1.8 is out" /><span class="news_date">2001-04-14: </span><span class="news_headline">Version 0.1.8 is out</span><?php gray_line(); ?>
    <p>
      Get it from the <a href="<?php print $root; ?>download.php">download page</a>. 
    </p>
  <a name="2001-03-30 Porting notes updated" /><span class="news_date">2001-03-30: </span><span class="news_headline">Porting notes updated</span><?php gray_line(); ?>
    <p>
      The <a href="<?php print $root; ?>darwin/porting.php">porting notes</a> have been updated with information on Mac OS X Final. 
    </p>
  <a name="2001-03-30 Version 0.1.7 is out!" /><span class="news_date">2001-03-30: </span><span class="news_headline">Version 0.1.7 is out!</span><?php gray_line(); ?>
    <p>
      Get it from the <a href="<?php print $root; ?>download.php">download page</a>. 
    </p>
  <a name="2001-03-24 Mac OS X is released!" /><span class="news_date">2001-03-24: </span><span class="news_headline">Mac OS X is released!</span><?php gray_line(); ?>
    <p>
      Expect Fink packages to be adapted to the final release within the next one or two weeks. 
    </p>
  <a name="2001-03-15 Libtool page updated" /><span class="news_date">2001-03-15: </span><span class="news_headline">Libtool page updated</span><?php gray_line(); ?>
    <p>
  ...
  <a name="2001-03-08 Version 0.1.6 is out" /><span class="news_date">2001-03-08: </span><span class="news_headline">Version 0.1.6 is out</span><?php gray_line(); ?>
    <p>
      Get it from the <a href="<?php print $root; ?>download.php">download page</a>. 
    </p>
