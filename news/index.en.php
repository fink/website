...
$cvs_date = 'Date: 2006/03/14 02:14:42';
$metatags = '';
...
the edges, but it should be usable if you are patient!
      ...
      <p>
To install it, you need to install the XCode compiler and SDK packages (at minimum).  Then you need to get the file <code>fink-0.24.12.tar.gz</code>
