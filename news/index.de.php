...
$cvs_date = 'Date: 2009/10/31 03:35:05';
$metatags = '';
...
<a name="2009-07-25 Fink Core Team Änderung."><span class="news-date">2009-07-25: </span><span class="news-headline">Fink Core Team Änderung.</span></a><?php gray_line(); ?>
      <p>
...
<a name="2007-12-10 Leopard, X11, and Fink"><span class="news-date">2007-12-10: </span><span class="news-headline">Leopard, X11, and Fink</span></a><?php gray_line(); ?>
  ...
  <a name="2007-11-18 PDB Website Down"><span class="news-date">2007-11-18: </span><span class="news-headline">PDB Website Down</span></a><?php gray_line(); ?>
...
<p><b>Update, 2007-12-10:  </b>The Package Database is up and running again, with enhanced features.</p>
  <a name="2007-10-26 Initial Leopard Support"><span class="news-date">2007-10-26: </span><span class="news-headline">Initial Leopard Support</span></a><?php gray_line(); ?>
...
<a name="2007-03-04 Problems with tar"><span class="news-date">2007-03-04: </span><span class="news-headline">Problems with tar</span></a><?php gray_line(); ?>
...
now run the update commands normally.
		...
		<a name="2006-08-19 Server down; workarounds available"><span class="news-date">2006-08-19: </span><span class="news-headline">Server down; workarounds available</span></a><?php gray_line(); ?>
...
<a name="2006-06-15 New Fink release."><span class="news-date">2006-06-15: </span><span class="news-headline">New Fink release.</span></a><?php gray_line(); ?>
      <p>
...
<a name="2006-05-10 CVS Troubles"><span class="news-date">2006-05-10: </span><span class="news-headline">CVS Troubles</span></a><?php gray_line(); ?>
      <p>
...
should again work normally.
    ...
    <a name="2006-03-03 Problem with Apple's Security Update 2006-001"><span class="news-date">2006-03-03: </span><span class="news-headline">Problem with Apple's Security Update 2006-001</span></a><?php gray_line(); ?>
      <p>
...
to Apple's documentation</a>.
    ...
    <a name="2006-02-21 Preliminary version of Fink on Intel"><span class="news-date">2006-02-21: </span><span class="news-headline">Preliminary version of Fink on Intel</span></a><?php gray_line(); ?>
<p>
...
<a name="2006-01-10 Fink ready for XCode 2.2 (but not for Intel)."><span class="news-date">2006-01-10: </span><span class="news-headline">Fink ready for XCode 2.2 (but not for Intel).</span></a><?php gray_line(); ?>
<p>
...
<a name="2005-11-16 XCode 2.2 (10.4 only)."><span class="news-date">2005-11-16: </span><span class="news-headline">XCode 2.2 (10.4 only).</span></a><?php gray_line(); ?>
<p>
...
<a name="2004-09-20 Fink 0.7.1 veröffentlich."><span class="news-date">2004-09-20: </span><span class="news-headline">Fink 0.7.1 veröffentlich.</span></a><?php gray_line(); ?>
<p>
...
<a name="2004-08-23 Probleme mit XCode 1.5"><span class="news-date">2004-08-23: </span><span class="news-headline">Probleme mit XCode 1.5</span></a><?php gray_line(); ?>
	<p>
...
teilen Sie uns dies auf der fink-devel Mailing-Liste mit. (Die gewöhnlichen Symptome sind: Einige Symbole fehlen nach dem Kompilieren mit g++.) Bereits bekannte Pakete die dieses Problem haben: octave, singular-factory, singular-libfac, und wahrscheinlich sdl.
	...
	<a name="06.04.2004 Fink 0.6.3 and 0.7.0 veröffentlicht."><span class="news-date">06.04.2004: </span><span class="news-headline">Fink 0.6.3 and 0.7.0 veröffentlicht.</span></a><?php gray_line(); ?>
<p>
...
<a name="19.02.2004 Hisst Eure Flagge!"><span class="news-date">19.02.2004: </span><span class="news-headline">Hisst Eure Flagge!</span></a><?php gray_line(); ?>
<p>
...
<a name="2004-02-02 Java 1.4.2 Update entfernt das Java SDK"><span class="news-date">2004-02-02: </span><span class="news-headline">Java 1.4.2 Update entfernt das Java SDK</span></a><?php gray_line(); ?>
<p>
...
<a name="18.01.2004 10.3 Binaries aktualisiert"><span class="news-date">18.01.2004: </span><span class="news-headline">10.3 Binaries aktualisiert</span></a><?php gray_line(); ?>
<p>
...
<a name="10.01.2004 Pssst, möchten Sie GNOME 2.4 installieren?"><span class="news-date">10.01.2004: </span><span class="news-headline">Pssst, möchten Sie GNOME 2.4 installieren?</span></a><?php gray_line(); ?>
<p>
