...
<a name="2009-10-30 Servers back to normal."><span class="news-date">2009-10-30: </span><span class="news-headline">Servers back to normal.</span></a><?php gray_line(); ?>
      ...
      and support.</p>
    <a name="2009-10-24 Server issues"><span class="news-date">2009-10-24: </span><span class="news-headline">Server issues</span></a><?php gray_line(); ?>
	...
	<a name="2009-08-28 Fink on 10.6."><span class="news-date">2009-08-28: </span><span class="news-headline">Fink on 10.6.</span></a><?php gray_line(); ?>
      <p>
...
<a name="2009-07-25 Fink Core Group changes."><span class="news-date">2009-07-25: </span><span class="news-headline">Fink Core Group changes.</span></a><?php gray_line(); ?>
      <p>
...
<a name="2008-07-23 End of 10.3 support."><span class="news-date">2008-07-23: </span><span class="news-headline">End of 10.3 support.</span></a><?php gray_line(); ?>
      <p>
...
<a name="2008-07-17 Mass package migration."><span class="news-date">2008-07-17: </span><span class="news-headline">Mass package migration.</span></a><?php gray_line(); ?>
      <p>
...
<a name="2008-06-26 New Fink release."><span class="news-date">2008-06-26: </span><span class="news-headline">New Fink release.</span></a><?php gray_line(); ?>
      <p>
...
<a name="2008-02-03 Mirror, mirror on the wall, will someone sponsor Fink at all?"><span class="news-date">2008-02-03: </span><span class="news-headline">Mirror, mirror on the wall, will someone sponsor Fink at all?</span></a><?php gray_line(); ?>
		<p>
...
<a name="12/01/2008 Le site web ne marche plus"><span class="news-date">12/01/2008: </span><span class="news-headline">Le site web ne marche plus</span></a><?php gray_line(); ?>	
  ...
  <a name="10/12/2007 Leopard, X11, et Fink"><span class="news-date">10/12/2007: </span><span class="news-headline">Leopard, X11, et Fink</span></a><?php gray_line(); ?>
  ...
  <a name="18/11/2007 Site PDB"><span class="news-date">18/11/2007: </span><span class="news-headline">Site PDB</span></a><?php gray_line(); ?>
...
fonctionnalités.</p>
  <a name="26/10/2007 Support de Leopard"><span class="news-date">26/10/2007: </span><span class="news-headline">Support de Leopard</span></a><?php gray_line(); ?>
...
<a name="04/03/2007 Problèmes avec tar"><span class="news-date">04/03/2007: </span><span class="news-headline">Problèmes avec tar</span></a><?php gray_line(); ?>
...
<p><b>Actualisé le 16 mars:</b> la nouvelle version de <code>dpkg</code> résout ce problème. Les utilisateurs peuvent exécuter normalement leurs commandes de mises à jour.
		...
		<a name="19/08/2006 Serveur inacessible - Solutions"><span class="news-date">19/08/2006: </span><span class="news-headline">Serveur inacessible - Solutions</span></a><?php gray_line(); ?>
...
<a name="24/07/2006 Rappel : l'arborescence &quot;10.4-transitional&quot; ne sera plus gérée au 1er août 2006"><span class="news-date">24/07/2006: </span><span class="news-headline">Rappel : l'arborescence "10.4-transitional" ne sera plus gérée au 1er août 2006</span></a><?php gray_line(); ?>
...
<a name='24/07/2006 "Les oiseaux de même plumage" de Fink à OSCON 2006'><span class="news-date">24/07/2006: </span><span class="news-headline">"Les oiseaux de même plumage" de Fink à OSCON 2006</span></a><?php gray_line(); ?>
...
<a name='01/07/2006 Juillet, "mois de mise à jour de Fink"'><span class="news-date">01/07/2006: </span><span class="news-headline">Juillet, "mois de mise à jour de Fink"</span></a><?php gray_line(); ?>
...
<a name="15/06/2006 Nouvelle version de Fink"><span class="news-date">15/06/2006: </span><span class="news-headline">Nouvelle version de Fink</span></a><?php gray_line(); ?>
...
<a name="10/05/2006 Problèmes avec CVS"><span class="news-date">10/05/2006: </span><span class="news-headline">Problèmes avec CVS</span></a><?php gray_line(); ?>
...
<a name="03/03/2006 Problème engendré par la dernière mise à jour de sécurité d'Apple 2006-001"><span class="news-date">03/03/2006: </span><span class="news-headline">Problème engendré par la dernière mise à jour de sécurité d'Apple 2006-001</span></a><?php gray_line(); ?>
...
<a name="21/02/2006 Version initiale de Fink sur Intel"><span class="news-date">21/02/2006: </span><span class="news-headline">Version initiale de Fink sur Intel</span></a><?php gray_line(); ?>
...
<a name="10/01/2006 Fink est prêt pour XCode 2.2 (mais par pour Intel)."><span class="news-date">10/01/2006: </span><span class="news-headline">Fink est prêt pour XCode 2.2 (mais par pour Intel).</span></a><?php gray_line(); ?>
...
<a name="16/11/2005 XCode 2.2 (utilisateurs Mac OS X 10.4 uniquement)"><span class="news-date">16/11/2005: </span><span class="news-headline">XCode 2.2 (utilisateurs Mac OS X 10.4 uniquement)</span></a><?php gray_line(); ?>
...
<a name="09/06/2005 Nouvelles versions Fink"><span class="news-date">09/06/2005: </span><span class="news-headline">Nouvelles versions Fink</span></a><?php gray_line(); ?>
...
<a name="29/04/2005 Fink et Tiger"><span class="news-date">29/04/2005: </span><span class="news-headline">Fink et Tiger</span></a><?php gray_line(); ?>
...
<a name="20/11/2004 Solution aux problèmes gcc"><span class="news-date">20/11/2004: </span><span class="news-headline">Solution aux problèmes gcc</span></a><?php gray_line(); ?>
...
so even if you know Fink fairly well, you might find it informative.</p><a name="2003-03-29 KDE 3.1.1 Final In Unstable"><span class="news-date">2003-03-29: </span><span class="news-headline">KDE 3.1.1 Final In Unstable</span></a><?php gray_line(); ?>
...
will be released as an update shortly thereafter.</p><a name="2003-03-18 KDE 3.1 Final In Stable"><span class="news-date">2003-03-18: </span><span class="news-headline">KDE 3.1 Final In Stable</span></a><?php gray_line(); ?>
...
release.</p><a name="2003-03-17 Apple X11 Beta 3 Released"><span class="news-date">2003-03-17: </span><span class="news-headline">Apple X11 Beta 3 Released</span></a><?php gray_line(); ?>
...
shortly.</p><a name="2003-02-14 New version of FinkCommander"><span class="news-date">2003-02-14: </span><span class="news-headline">New version of FinkCommander</span></a><?php gray_line(); ?>
...
other improvements.</a></p><a name="2003-02-07 DO NOT INSTALL VIREX 7.2"><span class="news-date">2003-02-07: </span><span class="news-headline">DO NOT INSTALL VIREX 7.2</span></a><?php gray_line(); ?>
...
Fink community informed about the situation as it develops.</p><a name="2003-01-26 Apple X11 Library Warning"><span class="news-date">2003-01-26: </span><span class="news-headline">Apple X11 Library Warning</span></a><?php gray_line(); ?>
...
12582912 bytes, while the old version had a filesize of 10541112 bytes.)</p><a name="2002-09-28 Fink 0.4.1 released"><span class="news-date">2002-09-28: </span><span class="news-headline">Fink 0.4.1 released</span></a><?php gray_line(); ?>
<p>The source release and the binary installer are available now, as well as all binary packages. For information about upgrading, visit the <a href="<?php print $root; ?>download/upgrade.php">Upgrade Matrix</a>. </p>
...
software before using Fink.</p><a name="2002-09-08 Test version of Jaguar updater available"><span class="news-date">2002-09-08: </span><span class="news-headline">Test version of Jaguar updater available</span></a><?php gray_line(); ?>
