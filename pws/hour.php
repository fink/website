<?
  ...
  $hours = get_hour_stats($conn,$from,$to,$filter);
  ...
  echo "<tr><td><h1>$string004</h1></td><td align=\"right\">\n";
  
  echo "<form action=\"hour.php\" method=\"post\">\n";
  ...
  echo "<table border=\"0\" cellspacing=\"0\" width=\"730\" cellpadding=\"2\" align=\"center\">\n";
  echo "<tr>\n";
  echo "<td class=\"title\">$string015</td>\n";
