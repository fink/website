...
<h1>P.M.F. - 6. Compile Problems - General</h1>
    ...
    <? $i18n_section= "compiler"; ?><a name="compiler">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Read the docs next time. To compile packages from source, you must
        ...
        compiler, <code>cc</code>.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "cvs"; ?><a name="cvs">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> You need to install the Developer Tools.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "missing-make"; ?><a name="missing-make">
...
No such file or directory at /sw/lib/perl5/Fink/Services.pm line 190.</pre><p>It means you need to install the Developer Tools.</p><p>On the other hand, if your error message looks like</p><pre>make: illegal option -- C</pre><p>then you've replaced the GNU version of the <code>make</code>
        ...
        <code>make</code>.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "head"; ?><a name="head">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> If you're seeing this:</p><pre>Unknown option: 1 Usage: head [-options] &lt;url&gt;...</pre><p>followed by a list of option descriptions, you have a broken
        ...
        easier to solve: rename <code>/sw/bin/HEAD</code>.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "also_in"; ?><a name="also_in">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> This occasionally happens with splitoff packages (i.e. the ones
        ...
        package that you are trying to install.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "weak_lib"; ?><a name="weak_lib">
...
MACOSX_DEPLOYMENT_TARGET environment variable set to: 10.1</pre><p>You may regard these as harmless. If you are curious, read through
        ...
        startup or not, for applications that use weak references.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "mv-failed"; ?><a name="mv-failed">
...
Failed: installing foo-0.1.2-3 failed</pre><p>then you should look for <code>libbar</code> somewhere
        further back in the output of your build attempt.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "node-exists"; ?><a name="node-exists">
    ...
    <? $i18n_section= "usr-local-libs"; ?><a name="usr-local-libs">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> This is a frequent source of problems, because the package
        ...
        back:</p><pre>sudo mv /usr/local.moved /usr/local</pre><? show_form (); ?></div>
    </a>
    <? $i18n_section= "toc-out-of-date"; ?><a name="toc-out-of-date">
...
rerun ranlib(1) (can't load from it)</pre><p>What you need to do is run ranlib (as root) on whatever library is
        ...
        run:</p><pre>sudo ranlib /sw/lib/libintl.a</pre><? show_form (); ?></div>
    </a>
    <? $i18n_section= "fc-atlas"; ?><a name="fc-atlas">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> This happens because one of the steps in the build of
        ...
        instead.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "basic-headers"; ?><a name="basic-headers">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.12: I get messages saying that I'm missing <code>stddef.h</code> | <code>wchar.h</code> | <code>stdlib.h</code> | <code>crt1.o</code>, or that my <q>C compiler cannot create executables</q>.</b></p><? show_form (); ?></div>
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Both of these problems are typically due to the absence of essential headers that are provided by the DevSDK package of
        ...
        the DevSDK package using a Custom Install.</p><p>The <q>cannot create executables</q> error can also occur when your Developer Tools version is for an earlier OS version.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "multiple-dependencies"; ?><a name="multiple-dependencies">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> To get around this, try updating a single package, then try to use
        ...
        process.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "dpkg-parse-error"; ?><a name="dpkg-parse-error">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> This means that somehow your dpkg database got corrupted, usually
        ...
        installed before the problem started occurring.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "freetype-problems"; ?><a name="freetype-problems">
...
undefined reference to _FT_Access_Frame</pre><p>then you probably have a binary version that built fine with
        ...
        via <code>sudo apt-get update ; sudo apt-get dist-upgrade</code>.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "dlfcn-from-oo"; ?><a name="dlfcn-from-oo">
...
sudo ln -s /usr/lib/libdl.dylib /usr/local/lib/libdl.dylib</pre><? show_form (); ?></div>
    </a>
    <? $i18n_section= "gcc2"; ?><a name="gcc2">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> This is because <code>gcc2</code> is a virtual package to
        ...
        part of their main Developer Tools installation.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "system-java"; ?><a name="system-java">
    ...
    <? $i18n_section= "dpkg-split"; ?><a name="dpkg-split">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Generally, this can be fixed by setting your environment up correctly, cf. <a href="usage-fink.php?phpLang=es#fink-not-found">this FAQ entry</a>.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "xml-parser"; ?><a name="xml-parser">
