...
Nous essayons.
Parfois, c'est facile et tout le monde en profite à la prochaine version du paquet.
Malheureusement, ce n'est pas toujours si simple avec la plupart des paquets.
...
Mais, nous avons porté les outils de gestion de paquet de Debian (dpkg, dselect, apt-get) et nous les utilisons ainsi que le format de paquet binaire .deb.
Nos paquets sont faits sur mesure pour Mac OS X / Darwin et n'utilise pas le format de paquet source Debian.
</p></div>
</a>
<a name="apple">
...
<a name="openosx">
<div class="question"><p><b>Q2.4: Quelles sont vos relations avec OpenOSX.com ?</b></p></div>
<div class="answer"><p><b>A:</b> 
Ils ont utilisé Fink pour compiler la première version de leur CD GIMP et refusent de le reconnaître.
Lire le <a href="http://fink.sourceforge.net/pr/openosx.php">communiqué officiel</a> pour de plus amples informations.
</p></div>
</a>
<a name="forked">
<div class="question"><p><b>Q2.5: Quelles sont vos relations avec macosx.forked.net ?</b></p></div>
<div class="answer"><p><b>A:</b> 
Ce site redistribue certains paquets Fink en tant que paquets avec installeur, identiques à ceux de Fink, mais avec leur propres textes, dans lesquels Fink n'est pas mentionné.
Lire le <a href="http://fink.sourceforge.net/pr/forked.php">communiqué officiel</a> pour de plus amples informations.
</p></div>
</a>
<a name="darwinports">
<div class="question"><p><b>Q2.6: Quelles sont vos relations avec Darwinports ?</b></p></div>
<div class="answer"><p><b>A:</b> 
...
<p align="right">
Next: <a href="mirrors.php?phpLang=fr">3 Miroirs de Fink</a></p>
