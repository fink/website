...
<a name="xlocale">
<div class="question"><p><b><? echo FINK_Q ; ?>8.1: De nombreux messages signallant que la locale n'est pas gérée par la bibliothèque C apparaissent (message en anglais : "locale not supported by C library"). Est-ce un problème ?</b></p></div>
...
<div class="answer"><p><b><? echo FINK_A ; ?>:</b> Toutes ces options sont des variantes de XFree86 - toutes basées sur le code de XFree86, mais il y a de légères différences entre elles. Il existe des options différentes sous Panther et sous Jaguar.</p><p>Sous Panther, vous avez le choix entre :</p><ul>
<li><p>X11 d'Apple (que vous trouverez sur le disque numéro 3). N'oubliez pas d'installer X11 SDK (situé sur le disque XCode) si vous voulez compiler des programmes  à partir des sources ou si vous avez l'intention d'installer d'autres paquets Fink reliés à X11.</p></li>
...
<p>Il représente <code>/usr/bin/perl</code>, qui fait partie de l'installation par défaut de Mac OS X. Ce paquet fournit aussi <code>system-perlXXX</code> et <code>perlXXX-core</code> selon la version X.X.X de l'interpréteur perl.</p>
</li>
