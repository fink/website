...
<h1>P.M.F. - 1. Preguntas generales</h1>
    ...
    <a name="usr-local">
      <div class="question"><p><b><?php echo FINK_Q ; ?>1.4: ¿Por qué Fink no se instala en /usr/local?</b></p></div>
