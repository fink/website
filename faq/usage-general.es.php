...
export PKG_CONFIG_PATH="/sw/lib/pkgconfig"</pre><p>It is often easiest just to add these to your startup files (e.g.
    ...
    <a name="virtpackage">
	  ...
	  defines (as of fink-0.19.2):
	    ...
	    <p>
	      ...
	      Runtime Environment. See also <a href="comp-general.php?phpLang=es#system-java">this FAQ
	      entry</a>.
	    </p>
	  </li>
	    ...
	    <p>
	      ...
	      also <a href="comp-packages.php?phpLang=es#cant-install-xfree">this FAQ entry</a>.
	    </p>
	  </li>
  ...
  <p align="right">
Next: <a href="usage-packages.php?phpLang=es">9 Package Usage Problems - Specific Packages</a></p>
