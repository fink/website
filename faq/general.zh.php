...
<h1>常见疑问（F.A.Q.） - 1. 一般性问题</h1>
    ...
    <a name="what">
      <div class="question"><p><b><?php echo FINK_Q ; ?>1.1: 什么是 Fink？</b></p></div>
...
对于从源代码构建软件包，我们使用我们自己的工具，称为 <code>fink</code>，它可以生成 <code>.deb</code> 软件包文件。
    ...
    <a name="naming">
      <div class="question"><p><b><?php echo FINK_Q ; ?>1.2: Fink 是什么意思？</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 没有什么特别含义，只是一个名字而已。它也不是什么缩写。</p><p>事实上，Fink 在德语中是雀类（属于鸟类）的意思。当我在给这个项目起名的时候，操作系统的名称 Darwin，使我联想到查尔斯·达尔文，Galapagos 群岛和进化论。然后我想起了学校时学过的关于达尔文雀的东西，以及它们尖尖的嘴...</p></div>
    </a>
    <a name="bsd-ports">
      <div class="question"><p><b><?php echo FINK_Q ; ?>1.3: Fink 和 BSD port 机制有什么区别（它被包括在 OpenPackages 和 GNU-Darwin 中）？</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 一些主要优点：</p><ul>
          <li>
            <p>
...
这使得它的使用会更安全，并最大限度降低与 Mac OS X 和第三方软件包可能造成的冲突。
    ...
    <a name="usr-local">
      <div class="question"><p><b><?php echo FINK_Q ; ?>1.4: 为什么 Fink 不安装在 /usr/local？</b></p></div>
...
<a href="relations.php?phpLang=zh">2. 与其它项目的关系</a></p>
