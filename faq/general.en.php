...
<h1>F.A.Q. - 1 General Questions</h1>
    ...
    <a name="what">
      ...
      <div class="answer"><p><b>A:</b> Fink wants to bring more Unix software to Mac OS X, which results
    ...
    <a name="naming">
      ...
      <div class="answer"><p><b>A:</b> Nothing, it's just a name. It's not even an acronym.</p><p>Well, actually Fink is the German name for Finch, a kind of bird. I
        ...
        and their beaks from school, and well, that's it...</p></div>
    </a>
    <a name="bsd-ports">
      <div class="question"><p><b>Q1.3: How is Fink different from the BSD port mechanism (this includes
        OpenPackages and GNU-Darwin)?</b></p></div>
      <div class="answer"><p><b>A:</b> Some main advantages:</p><ul>
          <li><p> It's written in Perl, not make/shell. Thus it doesn't rely
          ...
          <li><p> Fink doesn't install into /usr/local unless explicitly
    ...
    <a name="usr-local">
      <div class="question"><p><b>Q1.4: Why doesn't Fink install into /usr/local?</b></p></div>
      <div class="answer"><p><b>A:</b> There are several reasons, but the common line is "because breakage
    ...
    <a name="why-sw">
      <div class="question"><p><b>Q1.5: Then why did you choose /sw?</b></p></div>
      <div class="answer"><p><b>A:</b> That choice is quite arbitrary, but is likely to stay for the
        foreseeable future for practical (upgrade) issues as well as the fact
        that it's safe from conflicting with other packaging systems.</p></div>
    </a>
  <p align="right">
