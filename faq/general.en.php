...
$cvs_date = 'Date: 2005/06/22 13:36:11';
...
<h1>F.A.Q. - 1. General Questions</h1>
    ...
    <a name="usr-local">
      <div class="question"><p><b><? echo FINK_Q ; ?>1.4: Why doesn't Fink install into /usr/local?</b></p></div>
    ...
    <a name="why-sw">
      <div class="question"><p><b><? echo FINK_Q ; ?>1.5: Then why did you choose /sw?</b></p></div>
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b>  That choice is quite arbitrary, but is likely to stay for the foreseeable future for practical (upgrade) issues as well as the fact that it's safe from conflicting with other packaging systems.</p></div>
    </a>
