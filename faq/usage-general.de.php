...
$metatags = '<link rel="contents" href="index.php?phpLang=de" title="F.A.Q. Contents"><link rel="next" href="usage-packages.php?phpLang=de" title="Package Usage Problems - Specific Packages"><link rel="prev" href="comp-packages.php?phpLang=de" title="Compile Problems - Specific Packages">';
...
<h1>F.A.Q. - 8. Package Usage Problems - General</h1>
    ...
    <a name="compile-myself">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.3: How do I compile something myself using Fink-installed
        software?</b></p></div>
...
setenv MACOSX_DEPLOYMENT_TARGET 10.5</pre><p>(assuming that the build system is running OS 10.5 or later)</p><p>It is often easiest just to add these to your startup files (e.g.
    ...
    <a name="apple-x11-applications-menu">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.4: I can't run any of my Fink-installed applications using the
  ...
  <code>xorg-shlibs</code> packages </p>
    ...
    <a name="no-display">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.6: When I try to run an application, I get a message that says "cannot
    ...
    <a name="suggest-package">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.7: I don't see my favorite program in Fink. How do I suggest a new
    ...
    <a name="virtpackage">
      ...
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.8: What are all these <code>system-*</code> "virtual
...
<a href="usage-packages.php?phpLang=de">9. Package Usage Problems - Specific Packages</a></p>
