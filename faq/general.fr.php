...
<li>
<p>Fink n'installe rien dans /usr/local à moins d'une requête explicite et ne nécessite pas de jongler avec /usr/bin/make ou d'autres commandes fournies par le système. Cela rend son utilisation plus sûre et réduit au minimum les interférences avec Mac OS X et les paquets de tierce partie.</p>
</li>
</ul></div>
</a>
<a name="usr-local">
<div class="question"><p><b><? echo FINK_Q ; ?>1.4: Pourquoi Fink n'installe rien dans le répertoire /usr/local ?</b></p></div>
