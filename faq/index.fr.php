...
<h2>Contents</h2><ul>
	...
	mais apt-get ou dselect eux ne l'indiquent pas. Qui a raison ?</a></li><li><a href="usage-fink.php?phpLang=fr#unstable">5.8 There's this package in unstable that I want to install, but the
        ...
        Command not found."</a></li><li><a href="comp-general.php?phpLang=fr#missing-make">6.3 I'm getting an error message involving <code>make</code>
        </a></li><li><a href="comp-general.php?phpLang=fr#head">6.4 I'm getting a strange usage message from the head command. What's
