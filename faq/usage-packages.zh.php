...
现在《运行 X11》文档有专门一部分<a href="/doc/x11/trouble.php#immediate-quit">《故障排除》</a>针对这个常见问题。
    ...
    <a name="apple-x-delete">
      <div class="question"><p><b><? echo FINK_Q ; ?>9.5: 我希望苹果 X11 里面删除键和 XDarwin 中的作用一样。</b></p></div>
...
xmodmap $HOME/.Xmodmap</pre><p></p></div>
    ...
    <a name="gnome-two">
      <div class="question"><p><b><? echo FINK_Q ; ?>9.6: 我从 GNOME 1.x 升级到 GNOME 2.x，现在<code>gnome-session</code> 不会打开一个窗口管理器。</b></p></div>
...
exec gnome-session</pre></div>
    ...
    <a name="apple-x11-no-windowbar">
      <div class="question"><p><b><? echo FINK_Q ; ?>9.7: 我在 Panther 中升级到苹果 X11，现在看不到窗口的标题栏了。</b></p></div>
