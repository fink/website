...
<div class="question"><p><b><? echo FINK_Q ; ?>6.14: Il est impossible d'installer quoi que ce soit, un message indique que "dpkg est incapable d'analyser la structure du fichier /sw/var/lib/dpkg/status" (message en anglais : "dpkg: parse error, in file `/sw/var/lib/dpkg/status'"). De quoi s'agit-il ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.17: Fink signale que les paquets <code>gcc2</code> ou <code>gcc3.1</code> n'existent pas, mais il ne semble pas possible de les installer. Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.18: Fink signale qu'il ne peut résoudre la dépendance "system-java14-dev", mais il n'existe pas de paquet system-java14-dev (message en anglais <code>Failed: Can't resolve dependency "system-java14-dev"</code>). Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.19: Lors de l'installation d'un paquet, un message d'erreur apparaît signalant que dpkg n'arrive à exécuter dpkg-split pour vérifier si le paquet fait partie d'un paquet multiple (message en anglais : <q>dpkg (subprocess): failed to exec dpkg-split to see if it's part of a multiparter: No such file or directory</q>). Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.21: Lors du téléchargement d'un paquet, Fink tente de le faire à partir d'un site dont le nom contient <q>distfiles</q> et ne trouve pas le fichier. Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.24: Un message d'erreur comportant <code>MACOSX_DEPLOYMENT_TARGET </code> apparaît lors de la compilation d'un module Python. Que faire ?</b></p></div>
