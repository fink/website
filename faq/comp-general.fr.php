...
<a name="compiler">
<div class="question"><p><b><? echo FINK_Q ; ?>6.1: Un script configure signale qu'il ne peut trouver un "cc acceptable". De quoi s'agit-il ?</b></p></div>
...
<a name="cvs">
<div class="question"><p><b><? echo FINK_Q ; ?>6.2: Lors de l'exécution de "fink selfupdate-cvs", un message signale que "la commande cvs est introuvable" (message en anglais : "cvs: Command not found."). Que faire ?</b></p></div>
<div class="answer"><p><b><? echo FINK_A ; ?>:</b> Vous devez installer les Developer Tools.</p></div>
</a>
<a name="missing-make">
<div class="question"><p><b><? echo FINK_Q ; ?>6.3: Un message d'erreur relatif à <code>make</code> apparaît. Que faire ?</b></p></div>
...
<a name="mv-failed">
<div class="question"><p><b><? echo FINK_Q ; ?>6.6: Lors de la construction d'un paquet, un message indique que l'exécution de la commande mv a échoué (message en anglais : "execution of mv failed, exit code 1"). Que faire ?</b></p></div>
...
<a name="node-exists">
<div class="question"><p><b><? echo FINK_Q ; ?>6.7: Il est impossible d'installer ou de mettre à jour un paquet, un message indique qu'un "noeud" existe déjà (message en anglais : "node already exists"). Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.8: Des problèmes de compilation de paquet Fink apparaissent quand des bibliothèques ou des headers sont installés dans le répertoire /usr/local. Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.9: Lors de la construction d'un paquet, un message indique que la "table des matières" n'est pas à jour (message en anglais "table of contents out of date"). Que faire ?</b></p></div>
<div class="answer"><p><b><? echo FINK_A ; ?>:</b> Le message de sortie vous indique (hélas ! en anglais) ce qu'il faut faire. En général, il est de la forme suivante :</p><pre>ld: table of contents for archive: 
...
<a name="fc-atlas">
<div class="question"><p><b><? echo FINK_Q ; ?>6.10: Fink Commander se bloque quand on tente d'installer atlas. Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.11: Un message indique qu'il est impossible de trouver les fichiers <code>stddef.h</code>, ou <code>wchar.h</code>, ou <code>stdlib.h</code>, ou <code>crt1.o</code>, ou bien encore que le <q>compilateur C ne peut créer de fichiers exécutables</q> ( message en anglais "C compiler cannot create executables"). Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.12: Il est impossible de mettre à jour, un message indique que Fink est "incapable de résoudre des conflits de versions entre dépendances" (message en anglais "unable to resolve version conflict on multiple dependencies"). Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.15: Des messages d'erreur concernant `Dl_info' apparaissent. Que faire ?</b></p></div>
...
<a name="gcc2">
<div class="question"><p><b><? echo FINK_Q ; ?>6.16: Fink signale que les paquets <code>gcc2</code> ou <code>gcc3.1</code> n'existent pas, mais il ne semble pas possible de les installer. Que faire ?</b></p></div>
...
<a name="system-java">
<div class="question"><p><b><? echo FINK_Q ; ?>6.17: Fink signale qu'il ne peut résoudre la dépendance "system-java14-dev", mais il n'existe pas de paquet system-java14-dev (message en anglais <code>Failed: Can't resolve dependency "system-java14-dev"</code>). Que faire ?</b></p></div>
...
<a name="xml-parser">
<div class="question"><p><b><? echo FINK_Q ; ?>6.19: Un message d'erreur signalant que le module Perl XML est requis par intltool apparaît (message en anglais: <q>configure: error: XML::Parser perl module is required for intltool</q>). Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.20: Lors du téléchargement d'un paquet, Fink tente de le faire à partir d'un site dont le nom contient <q>distfiles</q> et ne trouve pas le fichier. Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.21: Comment utiliser des options variables lors de la compilation d'un paquet ?</b></p></div>
...
<a name="python-mods">
<div class="question"><p><b><? echo FINK_Q ; ?>6.23: Un message d'erreur comportant <code>MACOSX_DEPLOYMENT_TARGET </code> apparaît lors de la compilation d'un module Python. Que faire ?</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>6.24: Un message d'erreur signalant que <code>libtool</code>  ne reconnait pas l'option '-dynamic' apparaît (message en anglais <q>libtool: unrecognized option `-dynamic'</q>). Que faire ?</b></p></div>
