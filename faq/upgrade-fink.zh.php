...
gcc 3.3 compiler is out of date." 我应该怎么办？</b></p></div>
    ...
    <? $i18n_section= "fink-0220"; ?><a name="fink-0220">
      <div class="question"><p><b><? echo FINK_Q ; ?>4.2: I haven't had any package updates from Fink in a while.</b></p><? show_form (); ?></div>
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Check your version:</p><pre>fink --version</pre><p>There is a known problem with <code>fink-0.22.0</code> wherein rsync selfupdating stopped working.  To fix this, switch to CVS selfupdating via</p><pre>fink selfupdate-cvs	</pre><p>This will bring you a newer <code>fink</code> version.  After you do this we recommend switching back to rsync selfupdating:</p><pre>fink selfupdate-rsync</pre><? show_form (); ?></div>
    </a>
