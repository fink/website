...
<h1>F.A.Q. - 3 Fink mirrors</h1>
    ...
    <a name="when-use">
      ...
      <div class="answer"><p><b>A:</b> Fink mirrors are rsync servers mirroring the current and stable
        description files that Fink uses to build packages from source.</p></div>
    </a>
    <a name="why">
      ...
      <div class="answer"><p><b>A:</b> Rsync is a very fast protocol. It will update the description files
        ...
        a mirror close to you.</p></div>
    </a>
    <a name="where">
      <div class="question"><p><b>Q3.3: Where can I find more information about Fink mirrors?</b></p></div>
      <div class="answer"><p><b>A:</b> All Fink mirrors are consolidated under the finkmirrors.net domain.
        The Web-Site at http://finkmirrors.net/ has more information.</p></div>
    </a>
    <a name="when-not">
      <div class="question"><p><b>Q3.4: I cannot connect to rsync server, what should I do?</b></p></div>
      <div class="answer"><p><b>A:</b> Sometimes very strict firewalls forbid you to connect to rsync
        services. If that is the case simply continue using the CVS method</p></div>
    </a>
    <a name="otherinfogone">
      <div class="question"><p><b>Q3.5: I have switched to the rsync method now all info files from the
        unused trees are gone</b></p></div>
      <div class="answer"><p><b>A:</b> This is normal. The rsync update method will only update your
    ...
    <a name="howswitch">
      ...
      <div class="answer"><p><b>A:</b> By using fink selfupdate-rsync or fink selfupdate-cvs to switch to
        rsync or CVS, respectively.</p></div>
    </a>
    <a name="status">
    ...
    <a name="Master">
      ...
      <div class="answer"><p><b>A:</b> Sometimes it is hard to fetch a certain version of sources from the
