...
<h1>Ч.З.В. - 2. Связь с другими проектами</h1>
        ...
        <a name="upstream">
            <div class="question"><p><b><?php echo FINK_Q ; ?>2.1: Предоставляете ли вы свои патчи координаторам исходного ПО?</b></p></div>
            <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> Мы стараемся это делать. Иногда отправка патчей с нашей стороны несложна
        ...
        <a name="debian">
            <div class="question"><p><b><?php echo FINK_Q ; ?>2.2: Какое отношение вы имеете к проекту Debian? 
                    Переносите ли вы Debian Linux в Mac OS X?</b></p></div>
            <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> Официальных отношений между Fink и <a href="http://www.debian.org">Debian</a> нет. Fink
        ...
        <a name="apple">
            <div class="question"><p><b><?php echo FINK_Q ; ?>2.3: Какое отношение вы имеете к Apple?</b></p></div>
        ...
        <a name="darwinports">
            <div class="question"><p><b><?php echo FINK_Q ; ?>2.4: Какое отношение вы имеете к Darwinports?</b></p></div>
            <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> Darwinports и Fink являются взаимодополняющими проектами. Они имеют некоторые
