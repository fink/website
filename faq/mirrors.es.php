...
<h1>P.M.F. - 3 Espejos de distribución</h1>
    ...
    <a name="why">
      <div class="question"><p><b>Q3.2: Por qué deberia de usar espejos rsync?</b></p></div>
    ...
    <a name="where">
      <div class="question"><p><b>Q3.3: ¿Dónde podria encontrar mas información acerca de los espejos Fink?</b></p></div>
    ...
    <a name="status">
      <div class="question"><p><b>Q3.7: ¿Cómo puedo ver cual es el estatus actual de los espejos rsync?</b></p></div>
      <div class="answer"><p><b>A:</b> Yes, go to http://finkmirrors.net/status.html</p></div>
    </a>
    <a name="Master">
      <div class="question"><p><b>Q3.8: ¿Qué es un servidor espejo de archivos de distribución?</b></p></div>
  ...
  <p align="right">
Next: <a href="upgrade-fink.php?phpLang=es">4 Upgrading Fink (version-specific troubleshooting)</a></p>
