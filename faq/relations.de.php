...
$metatags = '<link rel="contents" href="index.php?phpLang=de" title="F.A.Q. Contents"><link rel="next" href="mirrors.php?phpLang=de" title="Fink mirrors"><link rel="prev" href="general.php?phpLang=de" title="General Questions">';
...
<h1>F.A.Q. - 2. Relations with Other Projects</h1>
    ...
    <a name="upstream">
      <div class="question"><p><b><?php echo FINK_Q ; ?>2.1: Do you contribute your patches back to the upstream maintainers?</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> We're trying to. Sometimes sending patches back is easy and  everyone is happy once the next release of the package is out. Unfortunately with most packages it's not that easy. Some common problems:</p><ul>
    ...
    <a name="debian">
      <div class="question"><p><b><?php echo FINK_Q ; ?>2.2: What is your relation with the Debian project? Are you porting Debian Linux to Mac OS X?</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> There is no formal relation between Fink and <a href="http://www.debian.org">Debian</a>. Fink is <b>not</b> a port  of the Debian GNU/Linux distribution. We have ported Debian's package management tools (dpkg, dselect, apt-get) though, and use these tools and the .deb binary package format. The actual packages are tailor-made for Mac OS X / Darwin and don't use the Debian source package  format.</p></div>
    </a>
    <a name="apple">
      <div class="question"><p><b><?php echo FINK_Q ; ?>2.3: What is your relation with Apple?</b></p></div>
    ...
    <a name="darwinports">
      <div class="question"><p><b><?php echo FINK_Q ; ?>2.4: What is your relation with Darwinports?</b></p></div>
...
<a href="mirrors.php?phpLang=de">3. Fink mirrors</a></p>
