...
<h1>P.M.F. - 2 Relaciones con Otros Proyectos</h1>
    ...
    <a name="upstream">
      ...
      <div class="answer"><p><b>A:</b> Estamos tratando. A veces el regresar los parches es fácil y todo el mundo está contento una vez que la version actualizada del paquete ha salido. Desafortunadamente con la mayoría de los paquetes no es tan fácil. Algunos problemas communes:</p><ul>
...
plataformas.
    ...
    <a name="openosx">
      <div class="question"><p><b>Q2.4: ¿Cuál es su relación con OpenOSX.com?</b></p></div>
      <div class="answer"><p><b>A:</b> Utilizaron Fink para construir el primer lanzamiento de su GIMP CD y se rehusan a reconocerlo debidamente. Lea el <a href="http://fink.sourceforge.net/pr/openosx.php">estatuto público</a> para mas detalles.</p></div>
    </a>
    <a name="forked">
      <div class="question"><p><b>Q2.5: ¿Cuál es su relación con macosx.forked.net?</b></p></div>
    ...
    <a name="darwinports">
      <div class="question"><p><b>Q2.6: ¿Cuál es su relación con Darwinports?</b></p></div>
