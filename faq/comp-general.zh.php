...
现在源代码发布版的 bootstrap 脚本会检查这一点，但你仍然会碰到这个问题，如果你使用二进制安装或在安装 Fink 以后又安装 libwww。
    ...
    <a name="mv-failed">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.6: 当我构建一个软件包时，"execution of mv failed, exit code 1" 错误是什么意思？</b></p></div>
...
Failed: installing foo-0.1.2-3 failed</pre><p>那么你应该在你构建输出信息的更前面的地方寻找有关 <code>libbar</code> 的信息。</p></div>
    ...
    <a name="node-exists">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.7: 我无法安装软件包或更新它，因为我碰到一个错误说一个 "node" 已经存在。</b></p></div>
    ...
    <a name="usr-local-libs">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.8: 我听说安装在 /usr/local/lib 的库有时会引起 Fink 构建的问题。是这样吗？</b></p></div>
    ...
    <a name="toc-out-of-date">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.9: 当我构建一个软件包的时候，我碰到一个消息说 "table of contents" 已经过时。我需要怎么办？</b></p></div>
    ...
    <a name="fc-atlas">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.10: 当我安装 atlas 时 Fink Commander 挂了。</b></p></div>
    ...
    <a name="multiple-dependencies">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.12: 我无法升级，因为 Fink "unable to resolve version conflict on multiple dependencies"。</b></p></div>
...
_FT_Access_Frame </pre><p>这通常是用于以前安装的 X11 的残余文件。你需要重新安装 X11 SDK。</p></div>
    ...
    <a name="dlfcn-from-oo">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.15: 我碰到一个涉及 `Dl_info' 的编译错误。</b></p></div>
...
sudo ln -s /usr/lib/libdl.dylib /usr/local/lib/libdl.dylib</pre></div>
    ...
    <a name="system-java">
    <div class="question"><p><b><? echo FINK_Q ; ?>6.17: Fink 提示说 <code>Failed: Can't resolve dependency "system-java14-dev"</code>，但我却找不到有这个软件包。</b></p></div>
    ...
    <a name="dpkg-split">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.18: 当我尝试安装东西的时候，我碰到 <q>dpkg (subprocess): failed to exec dpkg-split to see if it's part of a multiparter: No such file or directory</q> 这样的错误。我怎么修复它？</b></p></div>
    ...
    <a name="xml-parser">
      <div class="question"><p><b><? echo FINK_Q ; ?>6.19: 我碰到这个 <q>configure: error: XML::Parser perl module is required for intltool</q> 错误信息。我应该怎么办？</b></p></div>
