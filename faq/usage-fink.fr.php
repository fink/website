...
<li><p>Tout d'abord, téléchargez les fichiers <a href="http://fink.cvs.sourceforge.net/fink/dists/10.2/unstable/main/finkinfo/devel/">cvs-proxy</a> (un fichier .info et un fichier .patch) et placez-les dans votre arborescence locale. (c'est-à-dire /sw/fink/dists/local/main/finkinfo/).</p></li>
...
<div class="question"><p><b><? echo FINK_Q ; ?>5.11: À l'exécution de init.csh ou init.sh, un message d'erreur "Permission denied" apparaît. Que se passe-t-il ?</b></p></div>
...
<a name="cvs-busy">
<div class="question"><p><b><? echo FINK_Q ; ?>5.13: Lors de l'exécution de <q>fink selfupdate</q> ou "fink selfupdate-cvs", le message "<code>Updating using CVS failed. Check the error messages above.</code>" apparaît.</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>5.16: Le message "command not found" apparaît au lancement de Fink ou de tout autre paquet installé via Fink.</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>5.18: Impossible d'installer quoi que ce soit. Le message d'erreur suivant : "install-info: unrecognized option `--infodir=/sw/share/info'" apparaît.</b></p></div>
...
<div class="question"><p><b><? echo FINK_Q ; ?>5.19: Impossible de d'installer ou de supprimer quoi que ce soit à cause d'un problème "files list file".</b></p></div>
