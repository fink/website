...
<h1>Q.F.P. - 5. Installer, Utiliser et Entretenir Fink</h1>
    ...
    <a name="what-packages">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Depuis Fink 0.2.3, il y a la commande list.  Elle produit une liste
    ...
    <a name="moving">
      <div class="question"><p><b><? echo FINK_Q ; ?>5.4: Est-il possible de déplacer Fink vers un autre dossier après
	l'installation ?</b></p></div>
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Non. Vous pouvez bien sûr déplacer les fichiers en utilisant
    ...
    <a name="unstable">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Assurez-vous d'abord de savoir ce que signifie 'instable'. Peu de
   ...
   <a name="sudo">
      <div class="question"><p><b><? echo FINK_Q ; ?>5.9: Comment ne plus avoir à saisir son mot de passe après la
    ...
    <a name="dselect-access">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Vous avez certainement fait pointer apt sur un miroir Debian, qui
...
deb http://us.dl.sourceforge.net/fink/direct_download current main crypto</pre><p>
    ...
    <a name="cvs-busy">
      <div class="question"><p><b><? echo FINK_Q ; ?>5.12: Lors de l'exécution de <q>fink selfupdate</q> ou "fink
...
fink selfupdate-cvs</pre></div>
    ...
    <a name="kernel-panics">
      <div class="question"><p><b><? echo FINK_Q ; ?>5.13: Lors de l'utilisation de Fink, ma machine se fige, entre en kernel panic ou bien
