...
<div class="question"><p><b><? echo FINK_Q ; ?>7.5: Il est impossible de mettre à jour <code>libiconv</code>. Que faire ?</b></p></div>
<div class="answer"><p><b><? echo FINK_A ; ?>:</b> Si vous voyez apparaître des messages d'erreur semblables au suivant :</p><pre>libtool: link: cannot find the library `/sw/lib/libiconv.la'</pre><p>vous pouvez résoudre le problème en exécutant la commande :</p><pre>fink remove gettext-dev
