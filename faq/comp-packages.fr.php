...
<h1>Q.F.P. - 7 Problèmes de compilation de certains paquets</h1>
    ...
    <a name="libgtop">
      <div class="question"><p><b>Q7.1: La compilation d'un paquet échoue avec des messages d'erreur concernant <code>sed</code>.</b></p></div>
      <div class="answer"><p><b>A:</b> Ceci peut se produire si votre script de connexion (par exemple <code>~/.cshrc</code>) lance une commande qui écrit dans le terminal, exemple : "<code>echo Hello</code>" ou <code>xttitle</code>. Pour résoudre le problème, la solution la plus simple est de mettre les lignes qui causent problème en commentaires.</p><p>Si vous voulez conserver l'écho, vous pouvez le faire ainsi :</p><pre>if ( $?prompt) then 
	echo Hello 
endif</pre></div>
    </a>
    <a name="cant-install-xfree">
      <div class="question"><p><b>Q7.2: Lors d'une tentative de passage aux paquets XFree86 de Fink, il est impossible d'installer <code>xfree86-base</code> ou <code>xfree86</code>, car ces paquets entrent en conflit avec <code>system-xfree86</code>.</b></p></div>
...
sudo dpkg -r --force-depends xfree86-rootless-threaded-shlibs</pre><p>FinkCommander peut aussi supprimer des paquets. Dans la fenêtre "source", sélectionnez un paquet et utilisez "<code>Force Remove</code>" dans le menu <code>Source</code>.</p><p>Si vous avez installé system-xfree86, voir la précédente question pour savoir comment le supprimer.</p><p>Installez la version désirée de xfree86 :</p><p>
    ...
    <a name="cctools">
      <div class="question"><p><b>Q7.4: Lors de l'installation de KDE, le message suivant apparaît : 'Can't
  ...
  <p align="right">
Next: <a href="usage-general.php?phpLang=fr">8 Problème généraux d'utilisation de paquets</a></p>
