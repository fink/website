<?
$title = "Q.F.P. - Compiling (2)";
$cvs_author = 'Author: michga';
$cvs_date = 'Date: 2004/03/21 08:45:54';
$metatags = '<link rel="contents" href="index.php?phpLang=fr" title="Q.F.P. Contents"><link rel="next" href="usage-general.php?phpLang=fr" title="Package Usage Problems - General"><link rel="prev" href="comp-general.php?phpLang=fr" title="Compile Problems - General">';

include_once "header.inc";
?>

<h1>Q.F.P. - 7 Compile Problems - Specific Packages</h1>
    ...
    <a name="libgtop">
      ...
      <div class="answer"><p><b>A:</b> This can happen if your login script (e.g. <code>~/.cshrc</code>)
        ...
        following:</p><pre>if ( $?prompt) then echo Hello endif</pre></div>
    </a>
    ...
    <a name="change-thread-nothread">
      ...
      <div class="answer"><p><b>A:</b> If you are running the Fink version of XFree86 and you want to
        ...
        command-line with the commands:</p><pre>sudo dpkg -r --force-depends xfree86-base sudo dpkg -r
        --force-depends xfree86-shlibs sudo dpkg -r --force-depends
        xfree86-rootless sudo dpkg -r --force-depends
        xfree86-rootless-shlibs</pre><p>or to delete the threaded versions:</p><pre>sudo dpkg -r --force-depends xfree86-base-threaded sudo
        dpkg -r --force-depends xfree86-shlibs-threaded sudo dpkg -r
        --force-depends xfree86-rootless-threaded sudo dpkg -r --force-depends
        xfree86-rootless-threaded-shlibs</pre><p>FinkCommander also has a way to remove packages. In the source
  ...
  <p align="right">
Next: <a href="usage-general.php?phpLang=fr">8 Package Usage Problems - General</a></p>
