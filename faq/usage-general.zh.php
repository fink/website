...
<h1>常见疑问（F.A.Q.） - 8. 一般性软件包使用问题</h1>
    ...
    <a name="xlocale">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.1: 我碰到很多这样的消息："locale not supported by C library"。有问题吗？</b></p></div>
...
X11 文档有更多的<a href="/doc/x11/trouble.php#locale">细节</a>。
    ...
    <a name="passwd">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.2: 我的系统上突然多很很多陌生的用户，名字象 "mysql"，"pgsql"，和 "games"。
它们是哪来的？</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 
...
<code>niutil -list . /users</code> 命令看到这些苹果定义的用户。
    ...
    <a name="compile-myself">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.3: 如何使用 Fink 安装的软件编译一些我自己的东西？</b></p></div>
...
通常 "./configure --help" 会告诉你额外的编译选项。
    ...
    <a name="apple-x11-applications-menu">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.4: 我不能在苹果的 X11 的应用程序菜单里面运行任何 Fink 安装的程序。</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 苹果的 X11 不使用 Fink 的环境变量设置，这意味着应用程序菜单没有正确的环境变量设置来找到你的 Fink 程序。解决办法是在 Fink 安装的程序前面加上：</p><pre>source /opt/sw/bin/init.sh ; </pre><p>例如，如果你希望运行 Fink 安装的 GIMP，那么填入</p><pre>source /opt/sw/bin/init.sh ; gimp</pre><p>到你 GIMP 项的命令一栏。</p><p>你也可以编辑你的 .xinitrc 文件（在你的用户目录中）并添加：</p><pre>source /opt/sw/bin/init.sh</pre><p>到第一行之后。</p></div>
    </a>
    <a name="x-options">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.5: 我被 X11 的选择弄糊涂了：苹果 X11，XFree86，等等。我应该安装哪一个？</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 这些都是 XFree86 的变种（它们都基于 XFree86 的代码），但相互之间有一些轻微的差别。对于在 Panther 和 Jaguar 下有不同的可选方式。在 Panther 下你可以选择：</p><ul>
    ...
    <a name="no-display">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.6: 当我试图运行一个程序，我碰到一个错误信息说： "cannot open display:"。我应该怎么办？</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 这个错误意味着系统不能连接到你的 X 显示。确定你按下面的步骤处理：</p><p>1. 启动 X （苹果的 X11，XFree86，…）。</p><p>2. 确定你正确设置了 DISPLAY 环境变量。如果你使用 X 的默认设置，你应该这么做：</p><p>如果你使用 <code>tcsh</code></p><pre>setenv DISPLAY :0</pre><p>或如果你使用 <code>bash</code></p><pre>export DISPLAY=:0</pre></div>
    </a>
    <a name="suggest-package">
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.7: 我在 Fink 里面看不到我喜欢的那个程序。我应该怎么建议增加一个新的软件包到 Fink 里面？</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 在 Fink 项目的<a href="http://sourceforge.net/tracker/?atid=371315&amp;group_id=17203">软件包需求追踪器</a>。</p><p>注意你需要一个 SourceForge 帐号才可以添加。</p></div>
    </a>
    <a name="virtpackage">
    
      <div class="question"><p><b><?php echo FINK_Q ; ?>8.8: 这些名为 <code>system-*</code> 的“虚拟软件包”有些时候会存在，但我却不能自己安装或删除它们？</b></p></div>
      <div class="answer"><p><b><?php echo FINK_A ; ?>:</b> 
