...
<a name="where">
    ...
    <div class="answer"><p><b>A:</b> Tous les miroirs Fink sont fusionnés sous le nom de domaine finkmirrors.net. Vous trouverez de plus amples informations sur le site web http://finkmirrors.net/.
</p></div>
</a>
<a name="when-not">
...
<a name="otherinfogone">
    <div class="question"><p><b>Q3.5: Après passage à la méthode rsync, tous les fichiers info des arborescences inutilisées ont disparu.</b></p></div>
    <div class="answer"><p><b>A:</b> C'est normal. La méthode rsync ne met à jour que l'arborescence active, par exemple 10.3, et supprime tous les répertoires CVS.
</p></div>
</a>
<a name="howswitch">
...
<a name="status">
    <div class="question"><p><b>Q3.7: Comment connaître l'état actuel des miroirs rsync ?</b></p></div>
    <div class="answer"><p><b>A:</b> Allez sur http://finkmirrors.net/status.html</p></div>
</a>
<a name="Master">
