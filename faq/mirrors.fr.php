...
<a name="where">
    ...
    <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Tous les miroirs Fink sont fusionnés sous le nom de domaine finkmirrors.net. Vous trouverez de plus amples informations sur le site web http://finkmirrors.net/.
</p></div>
</a>
<a name="when-not">
    <div class="question"><p><b><? echo FINK_Q ; ?>3.4: Impossible de se connecter au serveur rsync. Que faire ?</b></p></div>
    <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Il arrive que certains murs pare-feu particulièrement efficaces vous empêchent de vous connecter à des services rsync. Dans ce cas, continuez à utiliser la méthode CVS.
</p></div>
</a>
<a name="otherinfogone">
    ...
    <div class="answer"><p><b><? echo FINK_A ; ?>:</b> C'est normal. La méthode rsync ne met à jour que l'arborescence active, par exemple 10.3, et supprime tous les répertoires CVS.
</p></div>
</a>
<a name="howswitch">
