...
どうしたらいいですか?
	...
	</a></li><li><a href="comp-general.php?phpLang=ja#compile-options">6.21 パッケージをビルドするときに、 Fink に違うオプションを使わせたい。</a></li><li><a href="comp-general.php?phpLang=ja#alternates">6.22 Whenever I try to build from source, Fink keeps waffling between alternate versions of the same library.</a></li><li><a href="comp-general.php?phpLang=ja#python-mods">6.23 Python モジュールをビルドする際に、<code>MACOSX_DEPLOYMENT_TARGET </code> の問題が出ます。</a></li><li><a href="comp-general.php?phpLang=ja#libtool-unrecognized-dynamic">6.24 I get <q>unrecognized option `-dynamic'</q> errors from <code>libtool</code>.</a></li></ul></li><li><a href="comp-packages.php?phpLang=ja"><b>7 コンパイルの問題 - 特定のバージョン</b></a><ul><li><a href="comp-packages.php?phpLang=ja#libgtop">7.1 <code>sed</code> を使うパッケージビルドが失敗します。</a></li><li><a href="comp-packages.php?phpLang=ja#cant-install-xfree">7.2 Fink の XFree86 パッケージに切替えたいけれど、 <code>system-xfree86</code>  とコンフリクトしているため <code>xfree86-base</code> | <code>xfree86</code> がインストールできません。</a></li><li><a href="comp-packages.php?phpLang=ja#change-thread-nothread">7.3 non-threaded 版の Fink XFree86 パッケージから threaded 版 (またはその逆) にはどうしたら切替えることができますか?</a></li><li><a href="comp-packages.php?phpLang=ja#cctools">7.4 KDE をインストール使用とすると、次のメッセージが出ます: 'Can't resolve dependency "cctools (&gt;= 446-1)"'</a></li><li><a href="comp-packages.php?phpLang=ja#libiconv-gettext">7.5 <code>libiconv</code> が更新できません。</a></li><li><a href="comp-packages.php?phpLang=ja#cplusplus-filt">7.6 パッケージがインストールできません。<code>c++filt</code> がないからです。 
        これはどこにありますか?</a></li><li><a href="comp-packages.php?phpLang=ja#gettext-tools">7.7 Fink が、 <code>gettext</code> の依存性に矛盾があるとだけ表示し、更新してくれません。</a></li><li><a href="comp-packages.php?phpLang=ja#Leopard-libXrandr">7.8 OS 10.5 で <b>gtk+2</b> がインストールできません。</a></li><li><a href="comp-packages.php?phpLang=ja#all-others">7.9 ここに載っていないパッケージで問題があります。</a></li></ul></li><li><a href="usage-general.php?phpLang=ja"><b>8 パッケージ使用上の問題 - 一般</b></a><ul><li><a href="usage-general.php?phpLang=ja#xlocale">8.1 このようなメッセージが大量に出ます。
...
<!--Generated from $Fink: faq.ja.xml,v 1.44 2009/10/25 05:21:38 babayoshihiko Exp $-->
