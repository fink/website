...
のエラーが出るだけです。</a></li><li><a href="usage-fink.php?phpLang=ja#bad-list-file">5.19 何もインストールできないし、削除もできません。 "files list file" と出るだけです。</a></li><li><a href="usage-fink.php?phpLang=ja#error-nineteen">5.20 Fink バイナリインストーラを使うと、ウィンドウ中に大きく "19" と出て、何もインストールできません。</a></li><li><a href="usage-fink.php?phpLang=ja#dselect-garbage">5.21 <code>dselect</code> でパッケージを選択すると、大量のゴミがでてきます。
これはどうやったら使えますか?</a></li><li><a href="usage-fink.php?phpLang=ja#perl-undefined-symbol">5.22 なぜ Fink コマンドを実行すると "dyld: perl undefined symbols" エラーが大量にでるのですか?</a></li><li><a href="usage-fink.php?phpLang=ja#cant-upgrade">5.23 Fink のバージョンをアップデートできないようです。</a></li><li><a href="usage-fink.php?phpLang=ja#spaces-in-directory">5.24 名前に空白が入っているボリュームやディレクトリに Fink を入れることはできますか?</a></li><li><a href="usage-fink.php?phpLang=ja#packages-gz">5.25 バイナリアップデートをしようとすると、 "File not found" または "Couldn't stat package source list file" というメッセージが大量に出ます。</a></li><li><a href="usage-fink.php?phpLang=ja#wrong-tree">5.26 OS | Developer Tools を変えたら、 Fink が認識してくれません。</a></li><li><a href="usage-fink.php?phpLang=ja#seg-fault">5.27 何かをインストールしようとしたら <code>gzip</code> | <code>dpkg-deb</code> のエラーが出る! 助けて!</a></li><li><a href="usage-fink.php?phpLang=ja#pathsetup-keeps-running">5.28 ターミナルウィンドウを開くと、
"Your environment seems to be correctly set up for Fink already."
というメッセージが出てログアウトします。</a></li><li><a href="usage-fink.php?phpLang=ja#ext-drive">5.29 
	メインパーティション以外に Fink をインストールしていますが、
	ソースからの更新ができません。
	<q>chowname</q> を含んだエラーが出ます。
	</a></li><li><a href="usage-fink.php?phpLang=ja#mirror-gnu">5.30 
	Fink がパッケージを更新しません。
	'gnu' ミラーが見つからないと言っています。
	</a></li><li><a href="usage-fink.php?phpLang=ja#cant-move-fink">5.31 
	Fink を更新できません。
	/sw/fink を移動できないからです。
	</a></li><li><a href="usage-fink.php?phpLang=ja#four-oh-three">5.32 403 errors when I use <code>apt-get</code> または <code>dselect</code> または Fink Commander Binary メニューを使うと、403 エラーが出ます。</a></li><li><a href="usage-fink.php?phpLang=ja#fc-cache">5.33 "No fonts found" というメッセージが出ます。</a></li><li><a href="usage-fink.php?phpLang=ja#non-admin-installer">5.34 インストーラから Fink をインストールできません。"volume doesn't support symlinks" エラーが出ます。</a></li></ul></li><li><a href="comp-general.php?phpLang=ja"><b>6 コンパイルの問題 - 一般</b></a><ul><li><a href="comp-general.php?phpLang=ja#compiler">6.1 configure スクリプトが "acceptable cc" が見つからないといってきます。
...
</a></li><li><a href="comp-general.php?phpLang=ja#fc-atlas">6.11 atlas をインストールしようとすると、 Fink Commander がハングアップします。</a></li><li><a href="comp-general.php?phpLang=ja#basic-headers">6.12 <code>stddef.h</code> | <code>wchar.h</code> | <code>crt1.o</code> が見つからない、
...
<!--Generated from $Fink: faq.ja.xml,v 1.34 2005/09/17 01:40:27 babayoshihiko Exp $-->
