...
<h1>Q.F.P. - 9 Package Usage Problems - Specific Packages</h1>
    ...
    <a name="apple-x-delete">
      ...
      <div class="answer"><p><b>A:</b> Some users have reported that the behavior of the
        ...
        files:</p><p><b>.Xmodmap:</b></p><pre>keycode 59 = Delete</pre><p><b>.Xresources:</b></p><pre>xterm*.deleteIsDEL: true xterm*.backarrowKey: false
        xterm*.ttyModes: erase ^?</pre><p><b>.xinitrc</b></p><pre>xrdb -load $HOME/.Xresources xmodmap
        $HOME/.Xmodmap</pre><p></p></div>
    </a>
    <a name="gnome-two">
      ...
      <div class="answer"><p><b>A:</b> While under GNOME 1.x <code>gnome-session</code> invokes the
        ...
        running <code>gnome-session</code>, e.g.:</p><pre>... exec metacity &amp; exec gnome-session</pre></div>
    </a>
