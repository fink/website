...
$cvs_date = 'Date: 2004/07/15 11:08:52';
...
<h1>Q.F.P. - 9. Problèmes d'utilisation spécifiques à certains paquets</h1>
    ...
    <a name="apple-x-delete">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Certains utilisateurs ont signalé que la touche <code>suppr</code> se comporte différemment sous XDarwin et sous X11 d'Apple. On peut rectifier cela en ajoutant les lignes suivantes au fichier de démarrage approprié de X :</p><p>
          <b>.Xmodmap :</b>
...
exec metacity &amp; exec gnome-session</pre><p>Note : ceci n'est plus vrai pour <b>GNOME 2.4</b>. Le lancement de <code>gnome-session</code> invoque un gestionnaire de fenêtres.</p></div>
    ...
    <a name="apple-x11-wants-xfree86">
      <div class="question"><p><b><? echo FINK_Q ; ?>9.11: Après installation de X11 d'Apple, Fink continue à vouloir installer xfree86.</b></p></div>
...
<p>Si la réinstallation de X11User ne suffit pas à résoudre le problème, consultez les instructions <a href="#special-x11-debug">débogage spécial</a> ci-dessous.</p>
     ...
     <a name="wants-xfree86-on-upgrade">
      <div class="question"><p><b><? echo FINK_Q ; ?>9.12: Après passage de la version 10.2 de Fink à la version 10.2-gcc3.3 ou 10.3, Fink veut installer XFree86 alors que X11 d'Apple est déjà installé.</b></p></div>
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Si les solutions données aux sections <a href="#apples-x11-wants-xfree86">Fink continue à vouloir installer XFree86</a> or <a href="#wants-xfree86-on-upgrade">Fink veut installer XFree86</a> ne résolvent pas votre problème, ou ne sont pas applicables à votre cas, vous devrez supprimer entièrement X11 et tous les paquets fantômes antérieurs ainsi que les paquets relatifs à X11, qu'ils soient installés partiellement ou non  :</p><pre>sudo dpkg -r --force-all system-xfree86 system-xfree86-42 system-xfree86-43 \
