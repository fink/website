...
<a name="missing-make">
<div class="question"><p><b>Q6.3: What does "make: command not found" mean?</b></p></div>
<div class="answer"><p><b>A:</b> It means you need to install the Developer Tools.</p></div>
</a>
<a name="make">
<div class="question"><p><b>Q6.4: make: illegal option -- C</b></p></div>
<div class="answer"><p><b>A:</b> 
...
<a name="head">
<div class="question"><p><b>Q6.5: I'm getting a strange usage message
...
<a name="also_in">
<div class="question"><p><b>Q6.6: When I try to install a package I get an error message about trying to overwrite a file that is in another package.</b></p></div>
...
<a name="weak_lib">
<div class="question"><p><b>Q6.7: After I installed the December 2002 Development Tools I get messages about "weak libraries".</b></p></div>
...
<a name="mv-failed">
<div class="question"><p><b>Q6.8: What does "execution of mv failed, exit code 1" mean when I try to build a package?</b></p></div>
...
<a name="node-exists">
<div class="question"><p><b>Q6.9: I can't install a package | update because I get a message that a "node" already exists.</b></p></div>
...
<div class="question"><p><b>Q6.10: I've heard that libraries installed in /usr/local/lib sometimes cause build problems for Fink. Is this true?</b></p></div>
...
<div class="question"><p><b>Q6.11: When I try to build a package, I get a message that a "table of contents" is out of date. What do I need to do?</b></p></div>
...
<a name="fc-atlas">
<div class="question"><p><b>Q6.12: Fink Commander hangs when I try to install atlas.</b></p></div>
...
<div class="question"><p><b>Q6.13: I get messages saying that I'm missing stddef.h. Where do I find it?</b></p></div>
...
<div class="question"><p><b>Q6.14: I can't update, because Fink is "unable to resolve version conflict on multiple dependencies".</b></p></div>
...
<div class="question"><p><b>Q6.15: I can't install anything because I get "dpkg: parse error, in file `/sw/var/lib/dpkg/status'"!</b></p></div>
...
<div class="question"><p><b>Q6.16: I get errors involving freetype.</b></p></div>
...
<div class="question"><p><b>Q6.17: I get build errors involving `Dl_info'.</b></p></div>
...
<a name="gcc2">
<div class="question"><p><b>Q6.18: Fink says I'm missing <code>gcc2</code> but I can't seem to install it.</b></p></div>
...
<p align="right">
Next: <a href="comp-packages.php">7 Compile Problems - Specific Packages</a></p>
