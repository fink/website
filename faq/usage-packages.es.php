...
<h1>P.M.F. - 9. Package Usage Problems - Specific Packages</h1>
    ...
    <? $i18n_section= "xmms-quiet"; ?><a name="xmms-quiet">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Make sure you have the "eSound Output Plugin" selected in the XMMS
        ...
        We don't have an analysis or a fix yet.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "nedit-window-locks"; ?><a name="nedit-window-locks">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> This is a known problem that occurs with recent versions of
        ...
        <code>lesstif</code>.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "xdarwin-start"; ?><a name="xdarwin-start">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> Don't Panic. The Running X11 document now has an extensive <a href="http://www.finkproject.org/doc/x11/trouble.php#immediate-quit">troubleshooting
        section</a> for this common problem.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "no-server"; ?><a name="no-server">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> First, make sure you are sourcing init.sh in your X startup
        ...
        <code>/usr/bin/X11R6</code> in your PATH.</p><? show_form (); ?></div>
    </a>
    ...
    <? $i18n_section= "libXmuu"; ?><a name="libXmuu">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> You are missing a file that is supposed to be installed by
        ...
        --reinstall xfree86-base-shlibs</code> for binaries.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "apple-x-bugs"; ?><a name="apple-x-bugs">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> First of all, if you previously had the "threaded" versions of
        ...
        Apple bug reporter</a>.</p><? show_form (); ?></div>
    </a>
...
xmodmap $HOME/.Xmodmap</pre><p></p><? show_form (); ?></div>
    </a>
...
exec metacity &amp; exec gnome-session</pre><p>Note:  this is no longer true for <b>GNOME 2.4</b>.  Running <code>gnome-session</code> invokes a window manager.</p><? show_form (); ?></div>
    </a>
    <? $i18n_section= "apple-x11-no-windowbar"; ?><a name="apple-x11-no-windowbar">
      ...
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> You didn't upgrade X11 to version "X11 1.0 - XFree86 4.3.0"
        included with Panther. You can install X11 from X11.pkg on Disk 3.</p><? show_form (); ?></div>
    </a>
...
/Library/Receipts/X11User.pkg; fink selfupdate; fink index</pre><p>Then, reinstall X11 from the third Panther CD (and the X11SDK from the
    ...
    <? $i18n_section= "wants-xfree86-on-upgrade"; ?><a name="wants-xfree86-on-upgrade">
      <div class="question"><p><b><? echo FINK_Q ; ?>9.12: Cambié la version de Fink 10.2 a 10.2-gcc3.3 ó 10.3, tengo instalado el X11 de Apple, y Fink me pide que instale XFree86.</b></p></div>
