...
$cvs_date = 'Date: 2003/12/08 04:13:26';
...
/Library/Receipts/X11User.pkg; fink selfupdate; fink index</pre><p>Then, reinstall X11 from the third Panther CD and X11SDK from the Xcode CD.</p><p>Note:  <code>system-xfree86</code> no longer requires the X11SDK for <code>fink-0.17.0</code> and later.</p></div>
</a>
...
xfree86-base xfree86-base-shlibs; rm -rf /Library/Receipts/X11SDK.pkg \
/Library/Receipts/X11User.pkg; fink selfupdate; fink index</pre><p>Then, reinstall X11 and the X11SDK.</p><p>Note:  <code>system-xfree86</code> no longer requires the X11SDK for <code>fink-0.17.0</code> and later.</p></div>
</a>
