...
$cvs_date = 'Date: 2003/02/19 15:31:11';
...
<a name="nedit-window-locks"><div class="question"><p><b>Q7.3: If I am editing a file in nedit, when I open another file its window pops up but is unresponsive.</b></p></div>
<div class="answer"><p><b>A:</b> This is a known problem that occurs with recent versions of nedit and lesstif on all platforms.  The workaround is to open a new window with File--&gt;New, then open the next file you want to work on.</p></div></a>
...
<a name="no-server"><div class="question"><p><b>Q7.5: When I try to start XDarwin I get the message &quot;xinit:  No such file or directory (errno 2):  no server &quot;/usr/X11R6/bin/X&quot; in PATH&quot;.</b></p></div>
...
<a name="xfree-keymapping"><div class="question"><p><b>Q7.6: I just upgraded to Mac
...
<a name="xterm-error"><div class="question"><p><b>Q7.7: xterm fails with &quot;dyld: xterm Undefined symbols:  xterm undefined reference to _tgetent expected to be defined in /usr/lib/libSystem.B.dylib&quot;.</b></p></div>
...
<a name="libXmuu"><div class="question"><p><b>Q7.8: When I try to start XFree86 I get one of the following errors:  &quot;dyld: xinit can't open library: /usr/X11R6/lib/libXmuu.1.dylib&quot; or &quot;dyld: xinit can't open library:  /usr/X11R6/lib/libXext.6.dylib&quot;</b></p></div>
<div class="answer"><p><b>A:</b> 
...
<a name="apple-x-bugs"><div class="question"><p><b>Q7.9: I had Fink's XFree86 installed, and I've replaced it with Apple's X11, and now everything's crashing!</b></p></div>
<div class="answer"><p><b>A:</b> 
...
<a name="apple-x-delete"><div class="question"><p><b>Q7.10: I want the delete key in Apple's X11.app to behave like that in XDarwin.</b></p></div>
