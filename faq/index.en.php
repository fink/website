...
<h1>The Fink F.A.Q.</h1>
  ...
  <h2>Contents</h2><ul>
	<li><a href="general.php?phpLang=en"><b>1 General Questions</b></a><ul><li><a href="general.php?phpLang=en#what">1.1 What is Fink?</a></li><li><a href="general.php?phpLang=en#naming">1.2 What does the name Fink stand for?</a></li><li><a href="general.php?phpLang=en#bsd-ports">1.3 How is Fink different from the BSD port mechanism (this includes
        ...
        fink command just says 'no package found'. How can I install it?</a></li><li><a href="usage-fink.php?phpLang=en#sudo">5.9 I'm tired of typing my password into sudo again and again. Is there
        a way around this?</a></li><li><a href="usage-fink.php?phpLang=en#exec-init-csh">5.10 When I try to run init.csh or init.sh, I get a "Permission denied"
        error. What am I doing wrong?</a></li><li><a href="usage-fink.php?phpLang=en#dselect-access">5.11 Help! I used the "[A]ccess" menu entry in dselect and now I can't
        download packages any more!</a></li><li><a href="usage-fink.php?phpLang=en#cvs-busy">5.12 When I try to run <q>fink selfupdate</q> or "fink
        selfupdate-cvs", I get the error "<code>Updating using CVS failed.
        Check the error messages above.</code>"</a></li><li><a href="usage-fink.php?phpLang=en#kernel-panics">5.13 When I use Fink, my whole machine freezes up/kernel panics/dies.
        Help!</a></li><li><a href="usage-fink.php?phpLang=en#not-found">5.14 I'm trying to install a package, but Fink can't download it. The
        download site shows a later version number of the package than what
        Fink has. What do I do?</a></li><li><a href="usage-fink.php?phpLang=en#fink-not-found">5.15 I get "command not found" errors when I run Fink or anything that I
        installed with Fink.</a></li><li><a href="usage-fink.php?phpLang=en#invisible-sw">5.16 I want to hide /sw in the Finder to keep users from damaging the
        Fink setup.</a></li><li><a href="usage-fink.php?phpLang=en#install-info-bad">5.17 I can't install anything, because I get the following error:
        "install-info: unrecognized option `--infodir=/sw/share/info'"</a></li><li><a href="usage-fink.php?phpLang=en#bad-list-file">5.18 I can't install or remove anything, because of a problem with a
        "files list file".</a></li><li><a href="usage-fink.php?phpLang=en#error-nineteen">5.19 When I use the Fink binary installer package, I get a big "19" in
        the window and can't install anything.</a></li><li><a href="usage-fink.php?phpLang=en#dselect-garbage">5.20 I get a bunch of garbage when I select packages in
        ...
        Command not found."</a></li><li><a href="comp-general.php?phpLang=en#missing-make">6.3 I'm getting an error message involving <code>make</code></a></li><li><a href="comp-general.php?phpLang=en#head">6.4 I'm getting a strange usage message from the head command. What's
        ...
        package for inclusion in Fink?</a></li></ul></li><li><a href="usage-packages.php?phpLang=en"><b>9 Package Usage Problems - Specific Packages</b></a><ul><li><a href="usage-packages.php?phpLang=en#xmms-quiet">9.1 I get no sound from XMMS</a></li><li><a href="usage-packages.php?phpLang=en#nedit-window-locks">9.2 If I am editing a file in nedit, when I open another file its
        ...
        Fink keeps asking to install xfree86.</a></li></ul></li></ul><!--Generated from $Fink: faq.en.xml,v 1.3 2004/03/15 15:10:23 alexkhansen Exp $-->
