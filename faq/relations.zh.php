...
<h1>常见疑问（F.A.Q.） - 2. 与其它项目的关系</h1>
    ...
    <a name="upstream">
      <div class="question"><p><b><? echo FINK_Q ; ?>2.1: 你是否会把你的补丁反馈给上游维护者？</b></p></div>
...
一些常见的原因：
    ...
    <a name="debian">
      <div class="question"><p><b><? echo FINK_Q ; ?>2.2: 你们和 Debian 项目的关系是什么？你们在把 Debian Linux 移植到 Mac OS X 上吗？</b></p></div>
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> 
Fink 和
...
实际的软件包是针对 Mac OS X / Darwin 进行了修正，并不使用 Debian 原始的包格式。
    ...
    <a name="apple">
      <div class="question"><p><b><? echo FINK_Q ; ?>2.3: 你们和苹果公司的关系是什么？</b></p></div>
      <div class="answer"><p><b><? echo FINK_A ; ?>:</b> 
