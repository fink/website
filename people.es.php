...
$cvs_date = '$Date: 2006/02/20 21:01:17 $';
...
<p>El proyecto de Fink es mantenido por un grupo de voluntarios. Cada
paquete de Fink package tiene un Maintainer que trabaja duro para
asegurarse que dicho paquete funciona como debe. Más aún, existe el
<a href="organization.php#core"> fink core team</a> que trabaja en el programa
fink.
El sitio web debe mantenerse al dia. Los usuarios necesitan soporte, 
proveido por las listas de correo y el canal de IRC. Estas y muchas mas 
tareas requieren mucho trabajo, así ´qúé, nos gustaría decir "Muchas 
Gracias" a todos los que sacrifican su tiempo libre para ayudar a la 
comunidad. Como tal, esta pagina contiene una lista de la gente que ha 
contribuido a Fink de alguna manera.</p>

<p>Tanta gente a ayudado a Fink que es dificil listar a todos. Si piensas 
que deberias estar en esta lista pero no lo estas, dejanos un correo y 
consideraremos incluirte en la siguiente revision de la lista.</p>

<p>Letras italicas denotan nicknames usados en el canal de IRC.</p>

<h2>Previo director del proyecto (retired)</h2>
<ul>
...
<ul>
<li>David H&#246;hn alias. Darian Lanx (<i>dmalloc</i>)</li>
</ul>

<h2>Contribuyentes Regulares</h2>
...
<h2>Equipo de soporte, traducción y documentación</h2>
<ul>
<li>Asari Takashi (<i>asari</i>)</li>
...
<h2>Contribuyentes Occasionales</h2>
