...
<h1>fink-i18n Mailing List</h1>

<p>
The main purpose of the fink-i18n list is to coordinate translation efforts.
Still, anyone is welcome to subscribe to the list that is willing to get involved
when it comes to web-site management, design and improvement.
</p>
<p>
...
<p>
The <a href="https://sourceforge.net/p/fink/mailman/fink-i18n">list
...
<p>
You can subscribe to fink-i18n by filling out this form.
...
<blockquote>
<form method="POST" action="https://lists.sourceforge.net/lists/subscribe/fink-i18n">
...
<p>
<form Method=POST ACTION="https://lists.sourceforge.net/lists/options/fink-i18n">
