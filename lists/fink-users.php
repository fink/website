...
<blockquote>
<form method="POST" action="https://lists.sourceforge.net/lists/subscribe/fink-users">
...
<p>
<form Method=POST ACTION="https://lists.sourceforge.net/lists/options/fink-users">
