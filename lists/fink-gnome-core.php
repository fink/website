<?php
$title = "Mailing Lists - fink-gnome-core";
...
<h1>fink-gnome-core Mailing List</h1>

<p>
The fink-gnome-core list is for discussion of bugs and packaging
issues in the GNOME desktop environment distributed by Fink.
</p>

<h2>Subscribe</h2>

<p>
You can subscribe to fink-gnome-core by filling out this form.
...
<blockquote>
<form method="POST" action="https://lists.sourceforge.net/lists/subscribe/fink-gnome-core">
...
<p>
<form Method=POST ACTION="https://lists.sourceforge.net/lists/options/fink-gnome-core">
