...
<h1>Часто задаваемые вопросы Fink </h1>
	...
	<li><a href="general.php?phpLang=ru"><b>1 Общие вопросы</b></a><ul><li><a href="general.php?phpLang=ru#what">1.1 Что такое Fink?</a></li><li><a href="general.php?phpLang=ru#naming">1.2 Что означает название Fink?</a></li><li><a href="general.php?phpLang=ru#bsd-ports">1.3  Чем Fink отличается от механизма переноса BSD (включая
                    ...
                    Переносите ли вы Debian Linux в Mac OS X?</a></li><li><a href="relations.php?phpLang=ru#apple">2.3 Какое отношение вы имеете к Apple?</a></li><li><a href="relations.php?phpLang=ru#openosx">2.4 Какое отношение вы имеете к OpenOSX.com?</a></li><li><a href="relations.php?phpLang=ru#forked">2.5 Какое отношение вы имеете к macosx.forked.net?</a></li><li><a href="relations.php?phpLang=ru#darwinports">2.6 Какое отношение вы имеете к Darwinports?</a></li></ul></li><li><a href="mirrors.php?phpLang=ru"><b>3 Зеркала Fink</b></a><ul><li><a href="mirrors.php?phpLang=ru#when-use">3.1 Что такое зеркала Fink?</a></li><li><a href="mirrors.php?phpLang=ru#why">3.2 Почему я должен использовать зеркала rsync?</a></li><li><a href="mirrors.php?phpLang=ru#where">3.3 Где можно найти более подробную информацию о зеркалах Fink?</a></li><li><a href="mirrors.php?phpLang=ru#when-not">3.4 Не устанавливается соединение с сервером rsync. Что делать?</a></li><li><a href="mirrors.php?phpLang=ru#otherinfogone">3.5 После перехода на метод rsync исчезли все информационные файлы на
                    ...
                    файлом списка файлов ("files list file").</a></li><li><a href="usage-fink.php?phpLang=ru#error-nineteen">5.19 При использовании пакета бинарного инсталлятора Fink в окне
                    появляется большая цифра "19" и я не могу ничего инсталлировать.</a></li><li><a href="usage-fink.php?phpLang=ru#dselect-garbage">5.20 Я получил кучу мусора, когда выбирал пакеты в 
                    <code>dselect</code>. Как теперь можно его использовать?</a></li><li><a href="usage-fink.php?phpLang=ru#perl-undefined-symbol">5.21 Почему я получаю кучу сообщений об ошибках "dyld: perl undefined symbols",
                    когда применяю команды Fink?</a></li><li><a href="usage-fink.php?phpLang=ru#cant-upgrade">5.22 Не получается обновить версию Fink.</a></li><li><a href="usage-fink.php?phpLang=ru#spaces-in-directory">5.23 Можно ли разместить Fink в томе или каталоге с пробелом в его имени?</a></li><li><a href="usage-fink.php?phpLang=ru#packages-gz">5.24 При попытке бинарного обновления появляется много сообщений
                    со словами "File not found"</a></li><li><a href="usage-fink.php?phpLang=ru#wrong-tree">5.25 Я изменил OS | Developer Tools, но Fink не
                    признает изменение.</a></li><li><a href="usage-fink.php?phpLang=ru#seg-fault">5.26 Получаю сообщения об ошибках с приложениями <code>gzip</code> | <code>dpkg-deb</code>I
                    ...
                    не может найти зеркало 'gnu'.</a></li><li><a href="usage-fink.php?phpLang=ru#cant-move-fink">5.30 Не могу обновить Fink, т.к. он не может убрать  /sw/fink..</a></li></ul></li><li><a href="comp-general.php?phpLang=ru"><b>6 Проблемы компиляции  - Общие вопросы</b></a><ul><li><a href="comp-general.php?phpLang=ru#compiler">6.1 Скрипт конфигурации жалуется, что не может найти
...
<!--Generated from $Fink: faq.en.xml,v 1.40 2004/12/02 16:41:59 alexkhansen Exp $-->
