...
<p>
Fink x?un progetto che vuole portare il mondo di Unix
...
(Questo processo x?chiamato porting.)
...
(Questo processo x?chiamato packaging.)
Il progetto offre pacchetti binari precompilati cosz?come buona parte del
...
Per ultima cosa, raccoglie i risultati in un pacchetto che x?pronto per
essere installato da <code>dpkg</code>.
</p>
<p>
Da quando Fink x?nato su Mac OS X, esso ha una ristretta politica per evitare
...
Fink ti apporta un accrescimento di queste utility cosz?come una selezione
di programmi di grafica sviluppati per Linux e altre varianti di Unix.
</p>

<p>
<b>Comodittｬ</b>
con Fink il processo di compilazione x?completamente automatizzato; non dovrai mai
...
<p>
<b>coerenza.</b>
Fink non x?solo una collezione casuale di pacchetti, x?una distribuzione 
coerente.
I file installati vengono posizionati in luoghi precisi.
La documentazione viene mantenuta aggiornata.
C'x?un'interfaccia di controllo dei processi.
E c'x?molto, molto di questo che lavora per te.
</p>

<p>
<b>Flessibilittｬ</b>
Tu devi solo scaricare e installare il programma di cui hai bisogno.
Fink ti dt柩a libertt枦i installare XFree86 o altre soluzioni X11
