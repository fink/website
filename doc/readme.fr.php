...
<!--Generated from $Fink: readme.fr.xml,v 1.4 2004/03/07 07:11:09 michga Exp $-->
    <p>
...
Il comprend aussi une liste complète des commandes disponibles.
  ...
  <h2><a name="questions">Autres questions</a></h2>
    ...
    <p>
Si la documentation incluse ne répond pas à  vos questions, allez sur le site web de Fink <a href="http://fink.sourceforge.net/">http://fink.sourceforge.net/</a> et consultez la page Aide :
...
Si vous voulez apporter votre contribution à Fink, la page Aide mentionnée ci-dessus contient également une liste de tâches à réaliser, tels les tests et la création de paquets.
  ...
  <h2><a name="uptodate">Dernières nouvelles</a></h2>
    ...
    <p>
La page du projet se trouve sur <a href="http://fink.sourceforge.net/">http://fink.sourceforge.net/</a>.
</p>
    <p>
Pour vous tenir informé des dernières versions, allez à <a href="http://fink.sourceforge.net/lists/fink-announce.php">http://fink.sourceforge.net/lists/fink-announce.php</a>
