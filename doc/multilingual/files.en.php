...
<h1>i18n - 2 The Documentation Files</h1>
    ...
    <h2><a name="initial-translation">2.6 Initial Translation</a></h2>
      ...
      <p>where xx is your language code (e.g.: fr for French language).
      Next, you'll want to translate the single quoted part of the define lines into your language. In case you don't understand German, here is the translation into English:</p>
    ...
    <h2><a name="committing">2.9 Committing the Changes (Team Leaders)</a></h2>
      ...
      <ul>
        ...
        file, do the following:<ol>
            ...
            the prompt. 
            Don't forget to also commit the Makefile if you've changed it (i.e. you've added your langague in it)</p></li>
