<?
$title = "Ejecutando X11 - Consejos";
$cvs_author = 'Author: michga';
$cvs_date = 'Date: 2004/10/25 10:15:38';
$metatags = '<link rel="contents" href="index.php?phpLang=es" title="Ejecutando X11 Contents"><link rel="prev" href="trouble.php?phpLang=es" title="Resolviendo problemas con XFree86">';


include_once "header.es.inc";
?>
<h1>Ejecutando X11 - 8. Consejos de uso</h1>
...
Si XDarwin se ejecuta en la misma máquina que el servidor, puedes hacerlo de las maneras siguientes:
      ...
      <ul>
        <li><p>Usuarios tcsh:</p>
      <pre>setenv DISPLAY :0.0</pre>
</li>
        <li><p>Usuarios bash:</p>
...
en Mac OS 10.2, o en el panel Cuentas en Mac OS 10.3):
      ...
      <ul>
        <li><p>Los usuarios tcshañadirán a su fichero .cshrc:</p>
      <pre>if (! $?DISPLAY) then
  setenv DISPLAY :0.0
endif</pre>
</li>
        <li><p>Los usuarios de bash añadirán esta línea 
...
De esa manera, se puede seguir ejecutando aplicaciones X11 a distancia mediante ssh o por un túnel X11.
    ...
    <h2><a name="open">8.2 Lanzando aplicaciones Aqua desde un xterm</a></h2>
...
El tercer ejemplo proporciona explícitamente la aplicación a utilizar.
    ...
    <h2><a name="copy-n-paste">8.3 Copiar y Pegar</a></h2>
      ...
      <p>
Copiar y Pegar funciona generalmente entre los entornos Aqua y X11, pero hay algunos errores. 
Emacs es especialemente delicado con la selección en curso.
