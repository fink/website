...
<p><b>Note</b> : il est impossible de démarrer XFree86 à partir de la console sous Mac OS X Panther.</p>
...
<code>startx</code> dans Terminal.app. Si vous démarrez le serveur de cette façon, vous devez lui indiquer qu'il fonctionnera en parallèle avec Quartz. Ce qui se fait en utilisant l'option <code>-fullscreen</code> :</p>
...
<p>Si le serveur gère le mode sans racine, vous pouvez le lancer dans ce mode avec l'option <code>-rootless</code> :</p>
...
<p>S'il n'existe pas de fichier <code>.xinitrc</code> dans votre répertoire utilisateur, XFree86 utilise le fichier par défaut <code>/private/etc/X11/xinit/xinitrc</code>. Vous pouvez vous servir de ce fichier comme base pour votre propre fichier .xinitrc :</p>
