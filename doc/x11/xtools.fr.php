...
$metatags = '<link rel="contents" href="index.php?phpLang=fr" title="Utilisation de X11 Contents"><link rel="next" href="other.php?phpLang=fr" title="Autres possibilités pour X11"><link rel="prev" href="run-xfree86.php?phpLang=fr" title="Lancement de X11">';
...
<p>Pour lancer Xtools, double-cliquez sur Xtools.app dans le répertoire Applications. Tout comme XFree86, Xtools lance les clients spécifiés dans le fichier <code>.xinitrc</code>. De plus, Xtools vous permet de lancer des clients via son menu.</p>
