<?
$title = "Ejecutando X11 - Instalando XFree86";
$cvs_author = 'Author: michga';
$cvs_date = 'Date: 2004/10/25 10:15:38';
$metatags = '<link rel="contents" href="index.php?phpLang=es" title="Ejecutando X11 Contents"><link rel="next" href="run-xfree86.php?phpLang=es" title="Arrancando XFree86"><link rel="prev" href="history.php?phpLang=es" title="Historia">';


include_once "header.es.inc";
?>
<h1>Ejecutando X11 - 3. Obteniendo e instalando XFree86</h1>
    
    
    <h2><a name="fink">3.1 Instalando a través de Fink</a></h2>
...
<a href="http://fink.sourceforge.net/doc/users-guide/upgrade.php">actualizar</a>
Fink.</p>
...
un paquete virtual <code>system-xfree86</code>.</p>
      <p>Bajo <code>fink-0.17.0</code> instalar X11 SDK solo es necesario si necesitas construir paquetes desde el código fuente.  
...
este último a las librerías compartidas. Si instalas el SDK, existe un paquete
...
Algunas notas de uso del X11 de Apple:
      ...
      <ul>
        <li>
          <p>El paquete <code>autocutsel</code> no se usa ya. Si estás arrancando X11 con él habilitado, debes deshabilitarlo.</p>
        </li>
        <li>
...
<code>init.csh</code> porque <code>.xinitrc</code> se ejecuta por <code>sh</code> y no por <code>tcsh</code>.</p>
        </li>
        <li>
...
ruta completa hasta el fichero, p.e.</p>
          ...
          <p>hay que usar algo como lo siguiente, si se está usando bash 
como shell por defecto:</p>
          <pre>. /sw/bin/init.sh ; emacs</pre>
          <p>o, si se está usando tcsh:</p>
...
/usr/X11R6/lib/libX11.6.dylib</pre>
          <p>entonces necesitas asegurarte de que <code>-lX11</code> se ha usado durante el enlazado (linking).  Comprueba las opciones de 
 configuración de tu paquete para ver como incluir el argumento extra.</p>
        </li>
        <li>
          <p>Si usas el paquete <code>xfree86</code> package, y después cambias al X11 de  Apple's X11 (en 10.2.x o en 10.3.x), cualquier paquete construido a 
través de  <code>xfree86</code> deberá ser reconstruido, pues los binarios son incompatibles.</p>
        </li>
      </ul>
...
La puedes enciontrar en tu    <a href="http://www.xfree86.org/MIRRORS.shtml">réplica de XFree86</a> 
...
binarios</a> de XonX, que provienen del mismo código fuente, pero son más fáciles de usar.  En cualquier caso descarga, descomprime y ejecuta las siguientes actualizaciones:</p>
      <ol>
        <li>Usuarios 10.1: <a href="http://prdownloads.sourceforge.net/xonx/XFree86_4.2.0.1-10.1.zip?download">4.2.0 -&gt; 4.2.0.1 upgrade</a>.  Usuarios 10.2:  <a href="http://prdownloads.sourceforge.net/xonx/XFree86_4.2.0.1-10.2.zip?download">4.2.0 -&gt; 4.2.0.1 upgrade</a>
        </li>
        <li>Usuarios de 10.1 y 10.2:  <a href="http://prdownloads.sourceforge.net/xonx/XFree86_4.2.1.1.zip?download">4.2.0.1 -&gt; 4.2.1.1 upgrade</a>
        </li>
      </ol>
      <p>También hay una distribución oficial binaria de la versión 4.3.0 
en las <a href="http://www.xfree86.org/MIRRORS.shtml">réplicas de XFree86 </a> en el directorio <code>4.3.0/binaries/Darwin-ppc-6.x</code>.
...
sudo make install install.man</pre>
      <p>Para actualizar  4.2.1.1, sigue las instrucciones en <a href="#official-binary">Binarios oficiales</a> section.</p>
...
.
    ...
    <h2><a name="latest-cvs">3.5 Versión para desarrolladores: lo último</a></h2>
...
durante 2001
no contiene XFree86, pero puede sobreescribir algunas ficheros de configuración de XFree86.
</p>
      <p>
...
4.1.0.
    ...
    <h2><a name="switching-x11">3.7 Reemplazando X11</a></h2>
...
<a href="run-xfree86.php?phpLang=es">4. Arrancando XFree86</a></p>
