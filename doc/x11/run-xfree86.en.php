...
.xinitrc:
      ...
      <p>
If you're using Fink, you should source <code>init.sh</code> (if you use bash shell) or <code>init.csh</code> (if you use tcsh shell) right at the beginning to make sure the environment is set up correctly.
</p>
      <p>
...
<p>Note: same change on the first line for tcsh users as stated above.</p>
