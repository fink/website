<?
$title = "Ejecutando X11 - Resolviendo problemas";
$cvs_author = 'Author: michga';
$cvs_date = 'Date: 2004/10/25 10:15:38';
$metatags = '<link rel="contents" href="index.php?phpLang=es" title="Ejecutando X11 Contents"><link rel="next" href="tips.php?phpLang=es" title="Consejos de uso"><link rel="prev" href="other.php?phpLang=es" title="Otras posibilidades X11">';


include_once "header.es.inc";
?>
<h1>Ejecutando X11 - 7. Resolviendo problemas con XFree86</h1>
...
ejecutando <code>touch .Xauthority</code> en tu directorio raíz.
      ...
      <p>
Tipo: Inofensivo.
Significa justo lo que dice: el sistema locale no es osportado por la librería C, 
...
running</pre>
      <p>
Tipo: Fatal.
Puede suceder si ejecutas accidentalemente varias instancias de 
...
librerías C estándares, el progrma usará los mensajes en inglés
...
o <code>de_DE</code>.
        ...
        <li>
          <p>
Pídele a Apple que incluya soporte real para locale en las futuras versines de 
Mac OS X.
</p>
        </li>
      </ul>
