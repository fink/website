...
$metatags = '<link rel="contents" href="index.php?phpLang=es" title="Ejecución de X11 Contents"><link rel="next" href="other.php?phpLang=es" title="Otras posibilidades X11"><link rel="prev" href="run-xfree86.php?phpLang=es" title="El arranque de XFree86">';


include_once "header.es.inc";
?>
<h1>Ejecución de X11 - 5. Xtools</h1>
    
    
    <h2><a name="install">5.1 Instalación de Xtools</a></h2>
...
actua como un paquete fantasma en el sistema de  dependencias de Fink.
    ...
    <h2><a name="run">5.2 Ejecución de Xtools</a></h2>
