...
<p><b>Introduit dans la version 0.11.0 de fink.</b> Ce champ déclare les bibliothèques partagées installées dans le paquet. Il y a une ligne par bibliothèque partagée, cette ligne est constituée de trois éléments séparés par des blancs : le nom d'installation de la bibliothèque <code>-install_name</code>, le numéro de version de compatibilité de la bibliothèque <code>-compatibility_version</code> et des informations de dépendance de version qui indiquent quel paquet de Fink fournit la bibliothèque à cette version de compatibilité. Les informations de dépendance doivent être spécifiées sous la forme <code> foo (&gt;= version-revision)</code>, où <code>version-revision</code> représente la <b>première</b> version d'un paquet Fink qui rend disponible cette bibliothèque (avec cette version de compatibilité). La déclaration Shlibs revient à dire que le mainteneur du paquet garantit qu'une bibliothèque portant ce nom et ayant une version de compatibilité au moins égale à <code>-compatibility_version</code> sera présente dans toutes les versions postérieures de ce paquet Fink.</p>
