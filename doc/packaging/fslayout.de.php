...
<table border="0" cellpadding="0" cellspacing="10"><tr valign="bottom"><th align="left">Field</th><th align="left">Value</th></tr><tr valign="top"><td><code>/opt/sw/bin</code></td><td>
<p>
...
<code>/opt/sw/lib</code>, außer es gibt sehr gute Gründe.
...
<code>/opt/sw/lib/perl5</code> oder <code>/opt/sw/lib/apache/1.3</code>.
...
<code>/opt/sw/lib/ppc64</code> für die PowerPC-Architektur und
<code>/opt/sw/lib/x86_64</code> für die i386-Architektur.
Bibliotheken, die als "fat" erzeugt wurden, sollten aber in
<code>/opt/sw/lib</code> abgespeichert werden und ein '32-64' in ihrem
Feld Shlibs eingetragen haben. Beachten sie, dass unter der x86_64-Architektur
64-bit-Bibliotheken in  <code>/opt/sw/lib</code> werden.
</p>
...
die selben Regeln wie für <code>/opt/sw/lib</code>.
...
Zu jedem Programm in  <code>/opt/sw/bin</code> und
<code>/opt/sw/sbin</code> sollte es hier eine entsprechende man-Page geben.
</p>
...
</td></tr><tr valign="top"><td><code>/opt/sw/opt</code></td><td>
<p>
...
<code>/opt/sw/bin</code>, <code>/opt/sw/lib</code>,
<code>/opt/sw/include</code>, usw. nicht verwenden können.
Ein Paket, das in <code>/opt/sw/opt</code> installiert wird, muss seine
statischen Dateien in einem separaten Unterverzeichnis
<code>/opt/sw/opt/&lt;package&gt;</code> abspeichern, wobei
...
Verzeichnis <code>/opt/sw</code> geben.
Insbesondere die folgenden sind explizit nicht erlaubt:
<code>/opt/sw/man</code>, <code>/opt/sw/info</code>,
<code>/opt/sw/doc</code>, <code>/opt/sw/libexec</code> und
