...
<p>Un paquet est un logiciel qui forme une unité atomique.
...
Dans Fink, les paquets peuvent exister sous deux formes : la description de paquet et le paquet binaire prêt à installer.</p>
<p>La description de paquet est un fichier texte compréhensible par un être humain qui contient tout ce qui est nécessaire pour construire le paquet, c'est-à-dire pour créer le paquet binaire.
...
La description peut être accompagnée d'une rustine.</p>
<p>Un paquet binaire est une archive qui contient effectivement les fichiers qui constituent le paquet, c'est-à-dire les exécutables, les fichiers de données, les catalogues de messages, les librairies, les fichiers include, etc...
...
Comme Fink construit les paquets avec le gestionnaire de paquets dpkg, les paquets binaires ont le format dpkg et ont une extension .deb.</p>


<h2><a name="ident">1.2 Identification d'un paquet</a></h2>
<p>Un paquet est identifié par trois éléments : le nom du paquet, la version et la révision.
...
En particulier, on ne peut utiliser de majuscules et de tiret de soulignement.</p>
<p>Le nom du paquet est tout simplement le nom du logiciel, par exemple openssh.
...
Le nom complet du paquet est constitué de la concaténation de ces trois éléments, séparés par des tirets, par exemple openssh-2.9p1-2.</p>
