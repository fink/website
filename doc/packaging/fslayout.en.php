...
directory (or prefix).
The examples use the default prefix of <code>/opt/sw</code>.
</p>
...
<code>/opt/sw/lib</code> unless there is a good reason not to.
...
as an additional hierarchy level, e.g. <code>/opt/sw/lib/perl5</code>
or <code>/opt/sw/lib/apache/1.3</code>.
...
Every program in <code>/opt/sw/bin</code> and
<code>/opt/sw/sbin</code> should have an associated manual page here.
</p>
...
which for some reason cannot use the standard <code>/opt/sw/bin</code>,
<code>/opt/sw/lib</code>, <code>/opt/sw/include</code>, etc. 
directories.
A package to be installed in <code>/opt/sw/opt</code>
 must locate its static files in a separate 
<code>/opt/sw/opt/&lt;package&gt;</code>
...
<code>/opt/sw/doc</code>, <code>/opt/sw/libexec</code>,
