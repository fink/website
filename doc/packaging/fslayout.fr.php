...
<table border="0" cellpadding="0" cellspacing="10"><tr valign="bottom"><th align="left">Répertoire</th><th align="left">Utilisation</th></tr><tr valign="top"><td><code>/opt/sw/bin</code></td><td>
<p>Ce répertoire est dédié aux exécutables généraux. Il n'existe pas de sous-répertoire.</p>
</td></tr><tr valign="top"><td><code>/opt/sw/sbin</code></td><td>
...
</td></tr><tr valign="top"><td><code>/opt/sw/include</code></td><td>
...
</td></tr><tr valign="top"><td><code>/opt/sw/lib</code></td><td>
<p>Ce répertoire est destiné aux fichiers de données et bibliothèques dépendants de l'architecture du système. Les bibliothèques statiques et partagées doivent être placées dans <code>/opt/sw/lib</code>, sauf s'il existe une bonne raison pour ne pas le faire. C'est également là que sont placés les exécutables qui ne doivent pas être directement lancés par l'utilisateur (dans le cas contraire, ils sont placés dans libexec).</p>
<p>On peut créer un sous-répertoire spécifique à un paquet, afin d'y mettre des données privées ou des modules chargeables. Pensez à utiliser des noms de répertoire qui garantissent la compatibilité entre versions. Il est bon d'utiliser le numéro de version majeur du paquet dans le nom du sous-répertoire ou à un niveau inférieur de la hiérarchie ; par exemple, <code>/opt/sw/lib/perl5</code> ou <code>/opt/sw/lib/apache/1.3</code>. Faites attention si vous utilisez le type d'hôte dans le nom des répertoires créés. Un sous-répertoire nommé <code>powerpc-apple-darwin1.3.3</code> ne garantit pas la compatibilité entre versions ; utilisez plutôt <code>powerpc-apple-darwin1.3</code> ou <code>powerpc-apple-darwin</code>.</p>
</td></tr><tr valign="top"><td><code>/opt/sw/lib/ppc64</code>
<code>/opt/sw/lib/x86_64</code></td><td>
<p>Ce répertoire est dédié aux bibliothèques 64-bit. Le répertoire <code>/opt/sw/lib/ppc64</code> est utilisé sous architecture powerpc et le répertoire <code>/opt/sw/lib/x86_64</code> sous architecture i386. Les bibliothèques combinées (fat) doivent être enregistrées dans le répertoire <code>/opt/sw/lib</code>.</p>
</td></tr><tr valign="top"><td><code>/opt/sw/share</code></td><td>
<p>Ce répertoire sert aux fichiers de données indépendants de l'architecture. Les mêmes règles que celles en vigueur pour <code>/opt/sw/lib</code> s'appliquent ici. Quelques sous-répertoires courants sont décrits ci-dessous.</p>
</td></tr><tr valign="top"><td><code>/opt/sw/share/man</code></td><td>
<p>Ce répertoire contient les pages de manuel. Son arborescence suit celle des sections courantes. Chaque programme installé dans <code>/opt/sw/bin</code> et <code>/opt/sw/sbin</code> doit avoir une page de manuel associée dans ce répertoire.</p>
</td></tr><tr valign="top"><td><code>/opt/sw/share/info</code></td><td>
...
</td></tr><tr valign="top"><td><code>/opt/sw/share/doc</code></td><td>
...
</td></tr><tr valign="top"><td><code>/opt/sw/share/locale</code></td><td>
<p>Ce répertoire contient les catalogues de messages de traduction.</p>
</td></tr><tr valign="top"><td><code>/opt/sw/var</code></td><td>
...
</td></tr><tr valign="top"><td><code>/opt/sw/etc</code></td><td>
...
</td></tr><tr valign="top"><td><code>/opt/sw/Library/Frameworks</code></td><td>
...
<p>Aucun autre répertoire que ceux mentionnés ci-dessus ne doit être créé dans <code>/opt/sw</code>. En particulier, les répertoires suivant ne doivent pas être utilisés : <code>/opt/sw/man</code>, <code>/opt/sw/info</code>, <code>/opt/sw/doc</code>, <code>/opt/sw/libexec</code> et <code>/opt/sw/lib/locale</code>.</p>
