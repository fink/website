...
<h1>パッケージ作成 - 3 パッケージ化ポリシー</h1>
		...
		<h2><a name="sharedlibs">3.3 共有ライブラリ</a></h2>
			...
			<p>
				...
				(パッケージメインテナが必要に応じて共有ライブラリの他に静的ライブラリもビルドすることは自由です．
...
BuildDepends: foo
			...
			<p>
				...
				この問題の回避のため，パッケージ <code>foo</code> に依存している全てのパッケージのメインテナがパッケージを上記のように改訂するまで，
...
Depends: foo-shlibs (= 正確な.バージョン), foo-bin
			...
			<p>
				こうすると， <code>foo</code> に依存する他のパッケージのメインテナが改訂を済ませるまで，
