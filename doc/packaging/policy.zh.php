...
<h2><a name="downloading">3.8 File Download Policy</a></h2>
    ...
    or build phases of the <a href="reference.php?phpLang=zh#build">build process</a>.  Any large patches (i.e.
    larger than can be accommodated conveniently in a PatchFile) that need to be applied should
    set up as additional Sources in accordance with the <a href="policy.php?phpLang=zh#sources">
    Source Policy.</a></p>
