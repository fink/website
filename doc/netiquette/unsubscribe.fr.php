...
<h1>Etiquette net - 4. Résiliation d'abonnemnent aux listes de diffusion</h1>
    ...
    <h2><a name="unsubscribing">4.1 Résiliation d'abonnement</a></h2>
      ...
      <ol>
        <li>Allez sur la page des <a href="http://fink.sourceforge.net/lists/index.php">Listes de diffusion</a>.  <p>Note :  n'utilisez pas la version MacOSX d'Internet Explorer.</p></li>
