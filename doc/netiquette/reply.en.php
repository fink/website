...
$metatags = '<link rel="contents" href="index.php?phpLang=en" title="netiquette Contents"><link rel="next" href="unsubscribe.php?phpLang=en" title="How to Unsubscribe from the Lists"><link rel="prev" href="first-post.php?phpLang=en" title="Intial Post">';
...
<h1>netiquette - 3 Replying to Posts</h1>
    ...
    <h2><a name="reply-to-list">3.1 Make Sure to Reply to the List</a></h2>
      
      <p>Unlike some other mailing lists to which you may be subscribed, the Fink lists are set up such that if you simply reply to a message, you will reply to the person who posted it, but <b>not</b> to the list.  Please make sure that you reply to the list:  </p>
      <ul>
      ...
      <p>Frequently people will use <q>Reply to All</q> to accomplish this:</p>
      <ul>
