...
?>
<h1>Netiquette - 3. Respondiendo a los "posts"</h1>
    
    
    
      <p>Este capítulo cubre como responder a los "posts".</p>
    
    <h2><a name="reply-to-list">3.1 Asegurate de responder a la Lista.</a></h2>
      
      <p>A diferencia de otras listas a las que estes suscrito, las Listas del Fink
      están ajustadas para que si respondes a un mensaje, la respuesta llega a quien puso el mensaje, pero <b>no</b> a la lista.  Por favor, asegurate de responder a la lista, así:  </p>
      <ul>
      ...
      <p>Frecuentemente se usa el comando <q>Reply to All</q> para lograr ésto:</p>
      <ul>
