<?php
$title = "Netiquette - Antworten";
$cvs_author = 'Author: KMS';
$cvs_date = 'Date: 2012/11/11 15:20:15';
$metatags = '<link rel="contents" href="index.php?phpLang=de" title="Netiquette Contents"><link rel="next" href="unsubscribe.php?phpLang=de" title="Abonnement kündigen"><link rel="prev" href="first-post.php?phpLang=de" title="Erste Anfrage">';


include_once "header.de.inc";
?>
<h1>Netiquette - 3. Antworten auf eine Nachricht</h1>
    
    
    
      <p>Hier wird beschrieben, wie sie auf Nachrichten antworten sollen.</p>
    
    <h2><a name="reply-to-list">3.1 Vergewissern sie sich, dass sie in der Mailing-Liste antworten</a></h2>
      
      <p>Im Gegensatz zu anderen sind die Einstellungen bei den Fink Mailing-Listen so, dass eine direkte Antowrt nur zu dem Verfasser der Nachricht geht, aber <b>nicht</b> an die Mailing-Liste selbst. Passen sie also auf, dass sie die Nachricht auch an die Mailing-Liste geht:
      </p>
      <ul>
      ...
      <p>Am einfachsten kann man das mit einem <q>An alle antworten</q> erreichen:</p>
      <ul>
...
<a href="unsubscribe.php?phpLang=de">4. Abonnement kündigen</a></p>
