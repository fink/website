...
$metatags = "<link rel=\"contents\" href=\"index.php?phpLang=cn\" title=\"用户指南 Contents\" /><link rel=\"next\" href=\"upgrade.php?phpLang=cn\" title=\"升级 Fink\" /><link rel=\"prev\" href=\"install.php?phpLang=cn\" title=\"首次安装\" />";
...
<a href="http://fink.sourceforge.net/faq/">FAQ</a>。
    ...
    <h2><a name="">3.6 可用版本</a></h2>
      ...
      <ul>
        ...
        <li>
          <p>
<b>0.6.2:</b>  This is the base version that can be installed from binaries for OS 10.2 or OS 10.3, under the current Fink release.  If you <a href="upgrade.php?phpLang=cn">upgrade</a> Fink, there may be an OS-specific newer version that isn't shown here.</p> 
        </li>
        <li>
          <p>
...
及 Mac OS X 上 X11 的文档</a>.
  ...
  <p align="right">
Next: <a href="upgrade.php?phpLang=cn">4 升级 Fink</a></p><? include_once "../../footer.inc"; ?>
