...
$metatags = "<link rel=\"contents\" href=\"index.php?phpLang=cn\" title=\"用户指南 Contents\" /><link rel=\"next\" href=\"packages.php?phpLang=cn\" title=\"安装软件包\" /><link rel=\"prev\" href=\"intro.php?phpLang=cn\" title=\"介绍\" />";
...
这会在<a href="upgrade.php?phpLang=cn">如何升级</a>一章进行介绍。
</p>
      <p>
在软件包管理工具安装好以后，你可以用它来安装更多的软件。
这会在 <a href="packages.php?phpLang=cn">安装软件包</a>一章进行介绍。
</p>
...
Fink 软件包可以添加它们自己的设置，例如，qt 软件会设置 QTDIR 环境变量。
      ...
      <p>
一旦你的环境设置好，继续
<a href="packages.php?phpLang=cn">安装软件包</a> 章节来了解如何用 Fink 所包括的软件包管理工具来安装一些实际的软件包。
</p>
    
  <p align="right">
Next: <a href="packages.php?phpLang=cn">3 安装软件包</a></p><? include_once "../../footer.inc"; ?>
