...
the Buildpath, slowing down builds.
        ...
        <h2><a name="downloading">5.5 Настройки скачивания</a></h2>
            ...
            <ul>
                ...
                <li>
                    <p>
                        <b>SelfUpdateMethod:</b> point, rsync или git</p>
                    <p> <code>fink</code> может использовать разные способы  для обновления
                        ...
                        использование rsync приведет к их удалению. Сначала сделайте резервную копию.
                         <b>git</b> произведет скачивание с использованием анонимного доступа или доступа
                        Github из хранилища fink. Недостатком при этом является то,
                        что git не может перемещаться от одного зеркала к другому, и если
