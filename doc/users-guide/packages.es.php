...
<a href="http://fink.sourceforge.net/faq/">FAQ</a>.
    ...
    <h2><a name="">3.6 Versiones disponibles</a></h2>
      ...
      <ul>
        ...
        <li>
          <p>
<b>0.7.1:</b>  Esta es la versión base que puede ser instalada de los binarios para 10.2 o OS 10.3, bajo la mas reciente liberación de Fink.  Si tí <a href="upgrade.php?phpLang=es">actualizas</a> Fink, puede existir una versión específica a tu OS que no se muestre aquí.</p> 
        </li>
        <li>
          <p>
