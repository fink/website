...
(下面的旧文档可以给你更详尽的概念：
<a href="http://www.finkproject.org/doc/bundled/install.php">安装</a>,
<a href="http://www.finkproject.org/doc/bundled/usage.php">使用</a>
以及包括在发行安装版本的磁盘映象中的 ReadMe.rtf 文件。)
同时也可以查阅本网站的
<a href="http://www.finkproject.org/doc/">文档部分</a> ，它包括一些其它的有用资讯。
</p>
    <p>
欢迎查看 Fink 用户指南。
