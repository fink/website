...
neu installieren zu müssen. Das wird im Kapitel <a href="upgrade.php?phpLang=de">Aktualisieren</a> behandelt.
</p>
      <p>
...
(.pkg), eingepackt in ein Diskimage (.dmg). Nachdem dieses von der 
<a href="/download/bindist.php">Download-Seite</a> heruntergeladen ist (Sie 
...
beendet ist, fahren Sie mit dem Abschnitt <a href="#setup">Einrichten Ihrer Umgebung</a> fort.
</p>
...
hier den Platzhalter  <code>fink-0.x.x-full</code> verwenden. Wechseln Sie jetzt 
...
erst die Paketverwaltung verfügbar sein muss.
      </p>
      <p>
...
die Umgebungsvariable QTDIR.
      ...
      <p>
Ist die Umgebung dann eingerichtet, können Sie mit dem Kapitel <a href="packages.php?phpLang=de">Pakete Installieren</a> fortfahren, um zu 
sehen, wie Sie endlich nützliche Pakete mit Hilfe der in Fink enthaltenen 
