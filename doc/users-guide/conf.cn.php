...
$metatags = "<link rel=\"contents\" href=\"index.php?phpLang=cn\" title=\"用户指南 Contents\" /><link rel=\"next\" href=\"usage.php?phpLang=cn\" title=\"在命令行使用 Fink 工具\" /><link rel=\"prev\" href=\"upgrade.php?phpLang=cn\" title=\"升级 Fink\" />";
...
ClosestFirst - 优先搜索最近的镜像服务器（把所有镜像服务器合在一组）。
  ...
  <p align="right">
Next: <a href="usage.php?phpLang=cn">6 在命令行使用 Fink 工具</a></p><? include_once "../../footer.inc"; ?>
