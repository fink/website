...
<a href="http://fink.sourceforge.net/faq/">FAQ</a>。
    ...
    <h2><a name="">3.6 可用版本</a></h2>
      ...
      <ul>
        ...
        <li>
          <p>
<b>0.7.0:</b>  This is the base version that can be installed from binaries for OS 10.2 or OS 10.3, under the current Fink release.  If you <a href="upgrade.php?phpLang=zh">upgrade</a> Fink, there may be an OS-specific newer version that isn't shown here.</p> 
        </li>
        <li>
          <p>
