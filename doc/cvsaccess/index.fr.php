...
$cvs_date = 'Date: 2006/03/01 05:16:38';
$metatags = '';
...
<!--Generated from $Fink: cvs.fr.xml,v 1.6 2006/03/01 05:16:38 michga Exp $-->
...
<p>Fink comporte plusieurs modules CVS. Le module <code>dists</code> (<a href="http://cvs.sourceforge.net/viewcvs.py/fink">ViewCVS</a>) contient les descriptions de paquets et les rustines pour Mac OS X versions 10.2 et ultérieures. Il existe d'autres modules pour les développeurs de Fink. Vous pouvez les afficher, mais ils n'ont aucun intérêt pour la plupart des utilisateurs.</p>
