...
Track</a></h2>
<p>
Start out by copying the <code>fink-0.45.2.tar.gz</code>
file to your home folder (it might also show up as <code>fink-0.45.2.tar</code> if you
...
to do that.</p>
<pre>[frodo:~] testuser% <b>tar xf fink-0.45.2.tar.gz</b>
[frodo:~] testuser% <b>cd fink-0.45.2</b>
[frodo:~/fink-0.45.2] testuser% <b>./bootstrap</b>

Fink must be installed and run with superuser (root) privileges
...
Choose a method: [1] <b>1</b>

sudo /Users/testuser/fink-0.45.2/bootstrap .sudo '/sw'
...
[frodo:~/fink-0.45.2] testuser% <b>cd</b>
[frodo:~] testuser% <b>rm -r fink-0.45.2</b>
