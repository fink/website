...
$metatags = '<link rel="contents" href="install.php?phpLang=en" title="Installation Contents"><link rel="next" href="install-first.php?phpLang=en" title="First Time Installation"><link rel="prev" href="install.php?phpLang=en" title="Installation Contents">';
...
<p>
If you're looking for the real instructions, skip to the <a href="install-first.php?phpLang=en">next section</a>.
...
Track</a></h2>
<p>
Start out by copying the <code>fink-0.41.1.tar.gz</code>
file to your home folder (it might also show up as <code>fink-0.41.1.tar</code> if you
...
to do that.</p>
<pre>[frodo:~] testuser% <b>tar xf fink-0.41.1.tar.gz</b>
[frodo:~] testuser% <b>cd fink-0.41.1</b>
[frodo:~/fink-0.41.1] testuser% <b>./bootstrap</b>
...
[frodo:~/fink-0.41.1] testuser% <b>cd</b>
[frodo:~] testuser% <b>rm -r fink-0.41.1</b>
...
<a href="install-first.php?phpLang=en">2. First Time Installation</a></p>
