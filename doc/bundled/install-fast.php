...
Track</a></h2>
<p>
Start out by copying the <code>fink-0.6.0-full.tar.gz</code>
...
<pre>[frodo:~] testuser% <b>tar xzf fink-0.6.0-full.tar.gz</b>
[frodo:~] testuser% <b>cd fink-0.6.0-full</b>
[frodo:~/fink-0.6.0-full] testuser% <b>./bootstrap.sh /sw</b>
...
sudo /Users/testuser/fink-0.6.0-full/bootstrap.pl .sudo '/sw'
...
[frodo:~/fink-0.6.0-full] testuser% <b>cd</b>
[frodo:~] testuser% <b>rm -r fink-0.6.0-full</b>
...
<pre>[frodo:~] testuser% <b>tar xzf fink-0.6.0-full.tar.gz</b>
[frodo:~] testuser% <b>cd fink-0.6.0-full</b>
[frodo:~/fink-0.6.0-full] testuser% <b>./inject.pl /sw</b>
sudo ./inject.pl /sw
Password:<b>(your normal password here)</b>
...
[frodo:~/fink-0.6.0-full] testuser% <b>cd pkginfo</b>
[frodo:~/fink-0.6.0-full/pkginfo] testuser% <b>./inject.pl /sw</b>
sudo ./inject.pl /sw
Copying...
...
...
[frodo:~/fink-0.6.0-full/pkginfo] testuser% <b>cd</b>
[frodo:~] testuser% <b>rm -r fink-0.6.0-full</b>
