...
Track</a></h2>
<p>
Start out by copying the <code>fink-0.39.5.tar.gz</code>
file to your home folder (it might also show up as <code>fink-0.39.5.tar</code> if you
...
to do that.</p>
<pre>[frodo:~] testuser% <b>tar xf fink-0.39.5.tar.gz</b>
[frodo:~] testuser% <b>cd fink-0.39.5</b>
[frodo:~/fink-0.39.5] testuser% <b>./bootstrap</b>
...
[frodo:~/fink-0.39.5] testuser% <b>cd</b>
[frodo:~] testuser% <b>rm -r fink-0.39.5</b>
