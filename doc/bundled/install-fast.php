...
Track</h2></a>
<p>
Start out by copying the <tt><nobr>fink-0.5.0a-full.tar.gz</nobr></tt>
...
<pre>[frodo:~] testuser% <b>tar xzf fink-0.5.0a-full.tar.gz</b>
[frodo:~] testuser% <b>cd fink-0.5.0a-full</b>
[frodo:~/fink-0.5.0a-full] testuser% <b>./bootstrap.sh /sw</b>
...
sudo /Users/testuser/fink-0.5.0a-full/bootstrap.pl .sudo '/sw'
...
[frodo:~/fink-0.5.0a-full] testuser% <b>cd</b>
[frodo:~] testuser% <b>rm -r fink-0.5.0a-full</b>
...
<pre>[frodo:~] testuser% <b>tar xzf fink-0.5.0a-full.tar.gz</b>
[frodo:~] testuser% <b>cd fink-0.5.0a-full</b>
[frodo:~/fink-0.5.0a-full] testuser% <b>./inject.pl /sw</b>
sudo ./inject.pl /sw
Password:<b>(your normal password here)</b>
...
[frodo:~/fink-0.5.0a-full] testuser% <b>cd pkginfo</b>
[frodo:~/fink-0.5.0a-full/pkginfo] testuser% <b>./inject.pl /sw</b>
sudo ./inject.pl /sw
Copying...
...
...
[frodo:~/fink-0.5.0a-full/pkginfo] testuser% <b>cd</b>
[frodo:~] testuser% <b>rm -r fink-0.5.0a-full</b>
