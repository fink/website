...
$metatags = '<link rel="contents" href="install.php?phpLang=de" title="Installation Contents"><link rel="next" href="install-first.php?phpLang=de" title="Erst-Installation"><link rel="prev" href="install.php?phpLang=de" title="Installation Contents">';
...
<code>fink-0.41.1.tar.gz</code> in ihr Heimatverzeichnis
kopieren (Möglicherweise wird sie als
<code>fink-0.41.1.tar</code> angezeigt, falls sie die Datei
