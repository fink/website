...
<p>
First, you need to unpack the fink-0.4.1-full.tar.gz tarball.
...
<pre>tar xzf fink-0.4.1-full.tar.gz</pre>
<p>
You now have a directory named fink-0.4.1-full.
Change to it with <tt><nobr>cd fink-0.4.1-full</nobr></tt>.
</p>
<p>
...
script.
So, to start installation, go to the fink-0.4.1-full directory and run
this command:
</p>
