...
<p>
First, you need to unpack the fink-0.5.0a-full.tar.gz tarball.
...
<pre>tar xzf fink-0.5.0a-full.tar.gz</pre>
<p>
You now have a directory named fink-0.5.0a-full.
Change to it with <tt><nobr>cd fink-0.5.0a-full</nobr></tt>.
</p>
<p>
...
script.
So, to start installation, go to the fink-0.5.0a-full directory and run
this command:
</p>
