...
<p>
First, you need to unpack the fink-0.6.0-full.tar.gz tarball.
...
<pre>tar xzf fink-0.6.0-full.tar.gz</pre>
<p>
You now have a directory named fink-0.6.0-full.
Change to it with <code>cd fink-0.6.0-full</code>.
</p>
<p>
...
script.
So, to start installation, go to the fink-0.6.0-full directory and run
this command:
</p>
