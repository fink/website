...
$metatags = '<link rel="contents" href="install.php?phpLang=en" title="Installation Contents"><link rel="next" href="install-up03.php?phpLang=en" title="Upgrading Fink"><link rel="prev" href="install-fast.php?phpLang=en" title="The Fast Track">';
...
<p>
First, you need to unpack the fink-0.41.1.tar.gz tarball (it might also show up as <code>fink-0.41.1.tar</code> if you
...
<p>
You now have a directory named fink-0.41.1.
Change to it with <code>cd fink-0.41.1</code>.
</p>
<p>
The actual installation is performed by the perl script
bootstrap.
So, to start installation, go to the fink-0.41.1 directory and run
this command:
</p>
<pre>./bootstrap</pre>
<p>
