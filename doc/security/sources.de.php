...
<h1>Sicherheitspolitik - 3. Quellen für Sicherheitslücken</h1>
    ...
    <h2><a name="sources">3.1 Akzeptierte Quellen für Sicherheitslücken.</a></h2>
      ...
      <ol>
        ...
        <li><b>BID</b>: Eintrag auf der Security Focus Bugtraq ID Datenbank</li>
        <li><b>BINDVIEW</b>: BindView security advisory</li>
        <li><b>BUGTRAQ</b>: Posting in der Bugtraq Mailing-Liste</li>
        ...
        <li><b>CONFIRM:</b> URL zum Hersteller, der die Sicherheitslücke bestätigt</li>
        ...
        <li><b>FULLDISC</b>: Full-Disclosure Mailing-Liste</li>
        ...
        <li><b>MISC</b>: generelle Referenz zu einer URL </li>
        <li><b>MLIST</b>: generelle Referenz für verschiedene Mailing-Listen</li>
        ...
        <li><b>SF-INCIDENTS</b>: Posting in der Security Focus Incidents Mailing-Liste</li>
        ...
        <li><b>VULN-DEV</b>: Posting in der VULN-DEV Mailing-Liste</li>
        <li><b>VULNWATCH</b>: VulnWatch Mailing-Liste</li>
        <li><b>XF</b>: X-Force Vulnerability Databank</li>
        <li><b>CVE</b>: CVE Candidates </li>
      </ol>
      <p>Die obigen Schlüsselworte stimmen mit der Empfehlung des CVE
        überein, wie man <a href="http://www.cve.mitre.org/data/refs/index.html">hier</a>
        nachlesen kann.</p>
    
  <p align="right"><?php echo FINK_NEXT ; ?>:
<a href="updating.php?phpLang=de">4. Sicherheitsaktualisierungen</a></p>
