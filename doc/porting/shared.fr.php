...
<p>Observez quelles sont les parties du numéro de version qui sont utilisées et où elles le sont. Notez aussi que l'éditeur de liens statiques utilisera le lien symbolique libfoo.dylib, tandis que l'éditeur de liens dynamique utilisera le lien symbolique libfoo.2.dylib. Il est possible de faire pointer ces liens symboliques sur différentes révisions mineures de la librairie.</p>
