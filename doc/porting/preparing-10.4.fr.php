...
<p>Dans Mac OS X 10.4, de nombreux symboles ont changé de types. Si vous aviez précedemment défini un type explicitement, comme, par exemple, <code>socklen_t</code> en tant que <code>int</code>, cette définition risque de ne plus être correcte.</p>
