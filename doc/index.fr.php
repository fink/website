...
$cvs_date = 'Date: 2005/03/02 05:09:40';
$metatags = '';
...
<!--Generated from $Fink: doc.fr.xml,v 1.13 2005/03/02 05:09:40 michga Exp $-->
...
<p>Documentation actuelle de l'utilisateur de Fink :</p>
<ul>
<li><a href="users-guide/index.php">Guide de l'utilisateur de Fink</a> - ce guide couvre l'installation de Fink, celle des paquets et la mise à jour de Fink lors d'une nouvelle version. Il contient les instructions pour les versions source et binaire.</li>
<li><a href="advanced/index.php">Guide des notions complexes dans Fink</a> -
couvre des sujets plus complexes que ceux abordés dans le Guide de l'utilisateur.</li>
<li><a href="x11/index.php">X11 sur Darwin et Mac OS X</a> - couvre les concepts généraux, l'installation et le lancement (les utilisateurs de Darwin et de Mac OS X y trouveront aussi des conseils utiles)</li>
</ul>
<p>Un grand nombre de documents plus complets, mais obsolètes et non remis à jour :</p>
<ul>
