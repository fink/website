...
<p>
<b>Statut :</b> 
nous avons posté un installeur pour Fink <?php print $fink_version; ?> (OS X 10.5).
</p>
<ul>
<li><a href="http://prdownloads.sourceforge.net/fink/Fink-<?php print $fink_version; ?>-PowerPC-Installer.dmg?download">Installeur binaire Fink <?php print $fink_version; ?> pour PowerPC</a> - <?php print $dmg_size; ?>, image disque compressée .dmg</li>
<li><a href="http://prdownloads.sourceforge.net/fink/Fink-<?php print $fink_version; ?>-Intel-Installer.dmg?download">Installeur binaire Fink <?php print $fink_version; ?> pour Intel</a> - <?php print $intel_dmg_size; ?>, image disque compressée .dmg</li>
