...
<ul>
<li><p><em>10.9-10.11:  </em>Run <code>xcode-select --install</code> from the Terminal and select the Install button.</p></li>
...
<p>If you install the full Xcode on 10.7-10.11, you will also want to run:</p>
