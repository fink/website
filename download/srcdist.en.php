...
<p>where you should replace <code>/path/to</code> with the actual path to the Xcode app.
...
<p>followed by</p>
<pre>tar -xvf fink-0.32.5.4.tar.gz</pre>
<p>or</p>
<pre>tar -xvf fink-0.32.5.4.tar</pre>
