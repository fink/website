...
$cvs_date = '$Date: 2012/04/09 23:55:29 $';
...
<p>The current version, <em>fink-0.32.5.5</em>, was officially released on
2012-04-09.</p>

<ul>
     <li>
For OS X 10.5-10.7, use <a href="http://downloads.sourceforge.net/fink/fink-0.32.5.5.tar.gz"
onClick="pageTracker._trackPageview('/downloads/FinkSOURCE');"> fink-0.32.5.5</a>
- 1300K, .tar.gz format
     </li>
     <li>
...
<p>followed by</p>
<pre>tar -xvf fink-0.32.5.5.tar.gz</pre>
<p>or</p>
<pre>tar -xvf fink-0.32.5.5.tar</pre>
