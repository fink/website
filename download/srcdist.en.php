...
$cvs_date = '$Date: 2012/07/16 18:31:42 $';
...
<p>The current version, <em>fink-0.34.0</em>, was officially released on
2012-07-16.</p>

<ul>
     <li>
For OS X 10.5-10.8, use <a href="http://downloads.sourceforge.net/fink/fink-0.34.0.tar.gz"
onClick="pageTracker._trackPageview('/downloads/FinkSOURCE');"> fink-0.34.0</a>
- 1308K, .tar.gz format
     </li>
     <li>
...
<p>followed by</p>
<pre>tar -xvf fink-0.34.0.tar.gz</pre>
<p>or</p>
<pre>tar -xvf fink-0.34.0.tar</pre>
