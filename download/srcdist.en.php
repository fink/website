...
$cvs_date = '$Date: 2012/07/06 23:44:41 $';
...
<p>The current version, <em>fink-0.33.3.2</em>, was officially released on
2012-07-06.</p>

<ul>
     <li>
For OS X 10.5-10.7, use <a href="http://downloads.sourceforge.net/fink/fink-0.33.3.2.tar.gz"
onClick="pageTracker._trackPageview('/downloads/FinkSOURCE');"> fink-0.33.3.2</a>
- 1304K, .tar.gz format
     </li>
     <li>
...
<p>followed by</p>
<pre>tar -xvf fink-0.33.3.2.tar.gz</pre>
<p>or</p>
<pre>tar -xvf fink-0.33.3.2.tar</pre>
