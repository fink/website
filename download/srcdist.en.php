...
$cvs_date = '$Date: 2012/06/12 03:07:35 $';
...
<p>The current version, <em>fink-0.33.0</em>, was officially released on
2012-04-09.</p>

<ul>
     <li>
For OS X 10.5-10.7, use <a href="http://downloads.sourceforge.net/fink/fink-0.33.0.tar.gz"
onClick="pageTracker._trackPageview('/downloads/FinkSOURCE');"> fink-0.33.0</a>
- 1302K, .tar.gz format
     </li>
     <li>
...
<p>followed by</p>
<pre>tar -xvf fink-0.33.0.tar.gz</pre>
<p>or</p>
<pre>tar -xvf fink-0.33.0.tar</pre>
