...
$cvs_date = '$Date: 2012/04/14 19:03:34 $';
...
<p>The current version, <em>fink-0.32.6</em>, was officially released on
2012-04-09.</p>

<ul>
     <li>
For OS X 10.5-10.7, use <a href="http://downloads.sourceforge.net/fink/fink-0.32.6.tar.gz"
onClick="pageTracker._trackPageview('/downloads/FinkSOURCE');"> fink-0.32.6</a>
- 1299K, .tar.gz format
     </li>
     <li>
...
<p>followed by</p>
<pre>tar -xvf fink-0.32.6.tar.gz</pre>
<p>or</p>
<pre>tar -xvf fink-0.32.6.tar</pre>
