...
$cvs_date = '$Date: 2010/11/09 16:06:30 $';
...
<p><em>fink-0.29.16</em> was officially released on 2010-11-09.</p>

<ul>
<li><a href="http://downloads.sourceforge.net/fink/fink-0.29.16.tar.gz" onClick="pageTracker._trackPageview('/downloads/FinkSOURCE');">fink-0.29.16</a> - 1178K, .tar.gz format</li>
</ul>
...
<pre>tar -xvzf fink-0.29.16.tar.gz</pre>

<p>or</p>

<pre>tar -xvf fink-0.29.16.tar</pre>

<p>if it has already been partially unpacked, in a terminal window.  Then, in a
terminal window, change to the resulting <em>fink-0.29.16</em> directory, and
use</p>
