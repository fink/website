...
<p>The current version, <em>fink-0.34.7</em>, was officially released on
2013-03-29.</p>

<ul>
     <li>
For OS X 10.5-10.8, use <a href="http://downloads.sourceforge.net/fink/fink-0.34.7.tar.gz"
onClick="pageTracker._trackPageview('/downloads/FinkSOURCE');"> fink-0.34.7</a>
- 1264K, .tar.gz format
     </li>
     <li>
...
<p>followed by</p>
<pre>tar -xvf fink-0.34.7.tar.gz</pre>
<p>or</p>
<pre>tar -xvf fink-0.34.7.tar</pre>
