...
Un pacchetto può ssere di due tipi: codice e binario.
...
Alcuni non arrivano al uno standard di qualità hanno problemi tecnici, altri
...
Il codice sorgente può ssere aggiornato all'ultima versione con il comando
'fink selfupdate'.
