<?php
$title = "Upgrade Instructions for macOS 10.13";
...
<h1>Upgrade Instructions for macOS 10.13</h1>
<h2>10.9/10/11/12 to 10.13</h2>
<ol>
	<li>
		Before installing 10.13, use <pre>fink selfupdate</pre> (with rsync or git) to get
	...
	<li>
		Use <pre>fink reinstall fink</pre> to point to the 10.13 distribution.
	</li>
	<li>
		Optional: 
...
<p>
	If you updated from 10.9/10/11/12 to 10.13 with a fink which doesn't know about 10.13, 
	you won't be able to proceed.  You can download a compatible 
	<link url="http://downloads.sourceforge.net/fink/fink_0.43.1-121_darwin-x86_64.deb">
   pre-built fink</link> and install it via the terminal by running
   <pre>sudo dpkg -i fink_0.43.1-121_darwin-x86_64.deb</pre> in the folder where you 
   downloaded it.
</p>

<h2>10.8 and earlier to 10.13:</h2>
<p>There is no supported upgrade path for Fink from 10.8 (or earlier) to 10.13.</p>
...
and saves them for later use during the Fink install on 10.13</p>
...
<ol>
    ...
    <li>Install macOS 10.13, as well as Xcode <?php echo $xcode_ver ?>, or the Command Line Tools at minimum.</li>
    <li><a href="./srcdist.php">Install Fink</a> on your new 10.13 system.</li>
...
<p>Not all of the packages available on 10.8 and earlier OS X versions are available on 10.13 due to several 
underlying changes in the system. Work is ongoing to make as many packages available 
as possible. If your favorite package is not available on 10.13, please contact the 
